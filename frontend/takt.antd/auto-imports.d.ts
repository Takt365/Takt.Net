...
export {}
declare global {
  const DateTimeHelper: typeof import('@/utils/datetime').DateTimeHelper
  const EffectScope: typeof import('vue').EffectScope
  const Modal: typeof import('ant-design-vue').Modal
  const TaktActionColumn: typeof import('@/components/business/takt-action-column/index.vue').TaktActionColumn
  const acceptHMRUpdate: typeof import('pinia').acceptHMRUpdate
  const computed: typeof import('vue').computed
  const confirm: typeof import('ant-design-vue').confirm
  const createActionColumn: typeof import('@/components/business/takt-action-column').createActionColumn
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly confirm: UnwrapRef<typeof import('ant-design-vue')['confirm']>
