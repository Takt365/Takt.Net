...
export type { GenTable, GenTableQuery, GenTableCreate, GenTableUpdate } from '@/types/code/generator/gen-table'

const tableUrl = '/api/TaktGenTables'

/** 获取代码生成表配置列表（分页），对应后端 GetGenTableListAsync */
...
/** 根据 ID 获取代码生成表配置，对应后端 GetGenTableByIdAsync */
...
/** 创建代码生成表配置，对应后端 CreateGenTableAsync */
...
/** 更新代码生成表配置，对应后端 UpdateGenTableAsync */
...
/** 删除代码生成表配置，对应后端 DeleteGenTableByIdAsync */
