 ...
 */
export function updateTenantStatus(data: TenantStatus): Promise<Tenant> {
  return request({
 ...
 * 对应后端：ImportAsync
 */
export function importTenantData(file: File, sheetName?: string): Promise<{ success: number; fail: number; errors: string[] }> {
