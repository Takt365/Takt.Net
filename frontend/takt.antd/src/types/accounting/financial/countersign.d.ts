...
// 命名空间：@/types/accounting/financial/countersign
// 文件名称：countersign.d.ts
// 创建时间：2025-02-02
// 创建人：Takt365
// 功能描述：countersign相关类型定义（自动生成）
// ========================================

import type { TaktEntityBase, TaktPagedQuery } from '@/types/common'

/**
 * Countersign类型（对应后端 Takt.Application.Dtos.Accounting.Financial.TaktCountersignDto）
 */
export interface Countersign extends TaktEntityBase {
  /** 对应后端字段 countersignId */
...
/**
 * CountersignQuery类型（对应后端 Takt.Application.Dtos.Accounting.Financial.TaktCountersignQueryDto）
 */
...
/**
 * CountersignCreate类型（对应后端 Takt.Application.Dtos.Accounting.Financial.TaktCountersignCreateDto）
 */
...
/**
 * CountersignUpdate类型（对应后端 Takt.Application.Dtos.Accounting.Financial.TaktCountersignUpdateDto）
 */
...
/**
 * CountersignStatus类型（对应后端 Takt.Application.Dtos.Accounting.Financial.TaktCountersignStatusDto）
 */
