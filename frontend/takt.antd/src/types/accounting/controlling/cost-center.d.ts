...
/**
 * CostCenterTree类型（对应后端 Takt.Application.Dtos.Accounting.Controlling.TaktCostCenterTreeDto）
 */
...
/**
 * CostCenterSort类型（对应后端 Takt.Application.Dtos.Accounting.Controlling.TaktCostCenterSortDto）
 */
