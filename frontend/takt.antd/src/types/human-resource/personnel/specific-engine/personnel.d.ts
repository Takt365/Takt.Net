...
// 命名空间：@/types/human-resource/personnel/specific-engine/personnel
// 文件名称：personnel.d.ts
// 创建时间：2025-02-02
// 创建人：Takt365
// 功能描述：personnel相关类型定义（自动生成）
// ========================================

import type { TaktEntityBase, TaktPagedQuery } from '@/types/common'

/**
 * EmployeeCreate类型（对应后端 Takt.Application.Dtos.HumanResource.Personnel.SpecificEngine.TaktEmployeeCreateDto）
 */
...
/**
 * EmployeeTransferStatus类型（对应后端 Takt.Application.Dtos.HumanResource.Personnel.SpecificEngine.TaktEmployeeTransferStatusDto）
 */
