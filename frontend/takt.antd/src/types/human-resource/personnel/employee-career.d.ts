...
export interface EmployeeCareer extends TaktEntityBase {
  /** 对应后端字段 employeeCareerId */
  employeeCareerId: string
  /** 对应后端字段 employeeId */
  employeeId: string
  /** 对应后端字段 lineNumber */
  lineNumber: number
...
export interface EmployeeCareerQuery extends TaktPagedQuery {
  ...
  /** 对应后端字段 joinDate */
  joinDate?: string
  /** 对应后端字段 joinDateStart */
  joinDateStart?: string
  /** 对应后端字段 joinDateEnd */
  joinDateEnd?: string
  /** 对应后端字段 regularizationDate */
  regularizationDate?: string
  /** 对应后端字段 regularizationDateStart */
  regularizationDateStart?: string
  /** 对应后端字段 regularizationDateEnd */
  regularizationDateEnd?: string
  /** 对应后端字段 leaveDate */
  leaveDate?: string
  /** 对应后端字段 leaveDateStart */
