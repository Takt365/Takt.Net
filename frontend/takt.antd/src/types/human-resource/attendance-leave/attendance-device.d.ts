...
export interface AttendanceDeviceQuery extends TaktPagedQuery {
  ...
  /** 对应后端字段 lastPullAt */
  lastPullAt?: string
  /** 对应后端字段 lastPullAtStart */
  lastPullAtStart?: string
  /** 对应后端字段 lastPullAtEnd */
  lastPullAtEnd?: string
  /** 对应后端字段 lastPushAt */
  lastPushAt?: string
  /** 对应后端字段 lastPushAtStart */
  lastPushAtStart?: string
  /** 对应后端字段 lastPushAtEnd */
  lastPushAtEnd?: string
  /** 对应后端字段 remark */
  remark?: string
  /** 对应后端字段 extFieldJson */
  extFieldJson?: string
...
/**
 * AttendanceDeviceDeviceStatus类型（对应后端 Takt.Application.Dtos.HumanResource.AttendanceLeave.TaktAttendanceDeviceDeviceStatusDto）
 */
export interface AttendanceDeviceDeviceStatus {
  /** 对应后端字段 attendanceDeviceId */
  attendanceDeviceId: string
  /** 对应后端字段 deviceStatus */
  deviceStatus: number
