...
// 命名空间：@/types/human-resource/attendance-leave/human-resource-attendance-leave-specific
// 文件名称：human-resource-attendance-leave-specific.d.ts
// 创建时间：2025-02-02
// 创建人：Takt365
// 功能描述：human-resource-attendance-leave-specific相关类型定义（自动生成）
// ========================================

import type { TaktEntityBase, TaktPagedQuery } from '@/types/common'

/**
 * AttendanceDeviceOnlineStatus类型（对应后端 Takt.Application.Dtos.HumanResource.AttendanceLeave.TaktAttendanceDeviceOnlineStatusDto）
 */
