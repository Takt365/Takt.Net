...
// 命名空间：@/types/human-resource/attendance-leave/specific-engine/attendance-leave
// 文件名称：attendance-leave.d.ts
// 创建时间：2025-02-02
// 创建人：Takt365
// 功能描述：attendance-leave相关类型定义（自动生成）
// ========================================
...
/**
 * ShiftSchedule类型（对应后端 Takt.Application.Dtos.HumanResource.AttendanceLeave.SpecificEngine.TaktShiftScheduleDto）
 */
