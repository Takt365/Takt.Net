...
export interface AttendanceExceptionQuery extends TaktPagedQuery {
  ...
  /** 对应后端字段 exceptionDate */
  exceptionDate?: string
  /** 对应后端字段 exceptionDateStart */
  exceptionDateStart?: string
  /** 对应后端字段 exceptionDateEnd */
...
/**
 * AttendanceExceptionHandleStatus类型（对应后端 Takt.Application.Dtos.HumanResource.AttendanceLeave.TaktAttendanceExceptionHandleStatusDto）
 */
export interface AttendanceExceptionHandleStatus {
  /** 对应后端字段 attendanceExceptionId */
  attendanceExceptionId: string
  /** 对应后端字段 handleStatus */
  handleStatus: number
