...
// 命名空间：@/types/human-resource/organization/human-resource-organization-specific
// 文件名称：human-resource-organization-specific.d.ts
// 创建时间：2025-02-02
// 创建人：Takt365
// 功能描述：human-resource-organization-specific相关类型定义（自动生成）
// ========================================
