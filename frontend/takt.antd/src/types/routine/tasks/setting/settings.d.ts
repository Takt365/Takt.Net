...
/**
 * SettingsSort类型（对应后端 Takt.Application.Dtos.Routine.Tasks.Setting.TaktSettingsSortDto）
 */
...
/**
 * SettingsSettingStatus类型（对应后端 Takt.Application.Dtos.Routine.Tasks.Setting.TaktSettingsSettingStatusDto）
 */
export interface SettingsSettingStatus {
  /** 对应后端字段 settingsId */
  settingsId: string
  /** 对应后端字段 settingStatus */
  settingStatus: number
