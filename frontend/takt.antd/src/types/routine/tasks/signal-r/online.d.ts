...
export interface Online extends TaktEntityBase {
  ...
  /** 对应后端字段 connectCountry */
  connectCountry?: string
  /** 对应后端字段 connectProvince */
...
export interface OnlineQuery extends TaktPagedQuery {
  ...
  /** 对应后端字段 lastActiveTime */
  lastActiveTime?: string
  /** 对应后端字段 lastActiveTimeStart */
  lastActiveTimeStart?: string
  /** 对应后端字段 lastActiveTimeEnd */
  lastActiveTimeEnd?: string
  /** 对应后端字段 disconnectTime */
  disconnectTime?: string
  /** 对应后端字段 disconnectTimeStart */
  disconnectTimeStart?: string
  /** 对应后端字段 disconnectTimeEnd */
...
/**
 * OnlineUpdate类型（对应后端 Takt.Application.Dtos.Routine.Tasks.SignalR.TaktOnlineUpdateDto）
 */
