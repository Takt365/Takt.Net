...
// 命名空间：@/types/logistics/quality/operation/sampling-scheme
...
/**
 * SamplingScheme类型（对应后端 Takt.Application.Dtos.Logistics.Quality.Operation.TaktSamplingSchemeDto）
 */
...
/**
 * SamplingSchemeQuery类型（对应后端 Takt.Application.Dtos.Logistics.Quality.Operation.TaktSamplingSchemeQueryDto）
 */
...
/**
 * SamplingSchemeCreate类型（对应后端 Takt.Application.Dtos.Logistics.Quality.Operation.TaktSamplingSchemeCreateDto）
 */
...
/**
 * SamplingSchemeUpdate类型（对应后端 Takt.Application.Dtos.Logistics.Quality.Operation.TaktSamplingSchemeUpdateDto）
 */
