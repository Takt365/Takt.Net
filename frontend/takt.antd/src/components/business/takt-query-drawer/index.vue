...
const title = computed(() =>
  props.title !== '' ? props.title : t('common.page.button.advancedquery')
)
const submitTextDisplay = computed(() =>
  props.submitText !== '' ? props.submitText : t('common.page.button.query')
)
const resetTextDisplay = computed(() =>
  props.resetText !== '' ? props.resetText : t('common.page.button.reset')
)
