...
const title = computed(() => props.title ?? t('common.page.button.columnsetting'))
const resetText = computed(() => props.resetText ?? t('common.page.button.reset'))
