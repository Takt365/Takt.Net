...
命名空间:@/components/common/takt-color-toggle
文件名称:index.vue
创建时间:2025-01-20
创建人:Takt365(Cursor AI)
功能描述:主题颜色切换组件,支持按钮、图标、下拉菜单、单选等多种展示模式
...
<template>
  ...
  >
    ...
    <slot>{{ $t('common.page.settings.color.switch') }}</slot>
  </a-button>
  ...
  >
    ...
    >
      ...
      <slot>{{ $t('common.page.settings.color.title') }}</slot>
    </a-button>
    <template #overlay>
      <a-menu
