  ...
  const allColumns = [
    {
      key: 'configId',
      dataIndex: 'configId',
      title: t('common.page.entity.configid'),
      width: 120,
      ellipsis: true
    },
    {
    ...
    },
    {
      ...
      title: t('common.page.entity.createdbyid'),
      width: 120,
      ellipsis: true
    },
    {
      key: 'createdBy',
      dataIndex: 'createdBy',
      title: t('common.page.entity.createby'),
      width: 120,
      ellipsis: true
    },
    {
    ...
    },
    {
      ...
      title: t('common.page.entity.updatedbyid'),
      width: 120,
      ellipsis: true
    },
    {
      key: 'updatedBy',
      dataIndex: 'updatedBy',
      title: t('common.page.entity.updateby'),
      width: 120,
      ellipsis: true
    },
    {
      key: 'updatedAt',
      dataIndex: 'updatedAt',
      title: t('common.page.entity.updatetime'),
      width: 180,
      ellipsis: true,
      sorter: (a: RowRecord, b: RowRecord) => {
    ...
    },
    {
      key: 'isDeleted',
      dataIndex: 'isDeleted',
      title: t('common.page.entity.isdeleted'),
      width: 100,
      ellipsis: true,
      sorter: (a: RowRecord, b: RowRecord) => {
    ...
    },
    {
      ...
      title: t('common.page.entity.deletedbyid'),
      width: 120,
      ellipsis: true
    },
    {
      key: 'deletedBy',
      dataIndex: 'deletedBy',
      title: t('common.page.entity.deletedby'),
      width: 120,
      ellipsis: true
    },
    {
      key: 'deletedAt',
      dataIndex: 'deletedAt',
      title: t('common.page.entity.deletedtime'),
      width: 180,
      ellipsis: true,
      sorter: (a: RowRecord, b: RowRecord) => {
