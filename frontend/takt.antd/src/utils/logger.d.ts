...
declare class ApiLogger {
     ...
     * API 请求日志
     */
    apiRequest(method: string, url: string, config?: unknown): void
    /**
     * API 响应日志
     */
...
export declare const logger: {
    debug: ConsolaInstance['debug']
    info: ConsolaInstance['info']
    warn: ConsolaInstance['warn']
    error: ConsolaInstance['error']
    success: ConsolaInstance['success']
    apiRequest: ApiLogger['apiRequest']
    apiResponse: ApiLogger['apiResponse']
    apiError: ApiLogger['apiError']
    networkError: ApiLogger['networkError']
    healthCheckError: ApiLogger['healthCheckError']
