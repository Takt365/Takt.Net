            ...
            <a-col :span="12">
              ...
              >
                <TaktSelect
                  ...
                  :placeholder="t('common.page.form.placeholder.select', { field: t('entity.plant.plantcode') })"
                />
              </a-form-item>
            </a-col>
            <a-col :span="12">
              ...
              >
                <a-input
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.plant.plantname') })"
                  show-count
                                    :maxlength="200"
                />
              </a-form-item>
            ...
            <a-col :span="12">
              ...
              >
                <a-input
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.plant.plantshortname') })"
                  show-count
                                    :maxlength="100"
                />
              </a-form-item>
            ...
            <a-col :span="12">
              ...
              >
                <a-input
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.plant.registrationaddress') })"
                  show-count
                                    :maxlength="500"
                />
              </a-form-item>
            ...
            <a-col :span="12">
              ...
              >
                <a-input
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.plant.businessaddress') })"
                  show-count
                                    :maxlength="500"
                />
              </a-form-item>
            ...
            <a-col :span="12">
              ...
              >
                <a-input
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.plant.plantaddress') })"
                  show-count
                                    :maxlength="500"
                />
              </a-form-item>
            ...
            <a-col :span="12">
              ...
              >
                <a-input
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.plant.plantphone') })"
                  show-count
                                    :maxlength="50"
                />
              </a-form-item>
            ...
            <a-col :span="12">
              ...
              >
                <a-input
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.plant.plantemail') })"
                  show-count
                                    :maxlength="100"
                />
              </a-form-item>
            ...
            <a-col :span="12">
              ...
              >
                <a-input
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.plant.plantmanager') })"
                  show-count
                                    :maxlength="50"
                />
              </a-form-item>
            ...
            <a-col :span="12">
              ...
              >
                <a-input
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.plant.businessscope') })"
                  show-count
                                    :maxlength="2000"
                />
              </a-form-item>
            ...
            <a-col :span="12">
              ...
              >
                <a-input
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.plant.plantstatus') })"
                  show-count
                                    :maxlength="10"
                />
              </a-form-item>
            ...
            <a-col :span="12">
              ...
              >
                <a-input
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.plant.ordernum') })"
                  show-count
                                    :maxlength="10"
                />
              </a-form-item>
            ...
            <a-col :span="12">
              ...
              >
                <a-input
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.plant.extfieldjson') })"
                  show-count
                                    :maxlength="4000"
                />
              </a-form-item>
            ...
            <a-col :span="12">
              ...
              >
                <a-input
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.plant.remark') })"
                  show-count
                                    :maxlength="500"
                />
              </a-form-item>
...
const rules = computed<Record<string, Rule[]>>(() => ({
  plantCode: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.plant.plantcode') }),
      trigger: 'change'
    }
  ],
  plantName: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.plant.plantname') }),
      trigger: 'blur'
    }
  ],
  plantStatus: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.plant.plantstatus') }),
      trigger: 'blur'
    }
  ],
  sortOrder: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.plant.sortorder') }),
      trigger: 'blur'
    }
  ],
}))
