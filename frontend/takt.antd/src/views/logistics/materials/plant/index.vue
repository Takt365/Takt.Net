  ...
  <div class="logistics-materials-plant">
    ...
    >
      <TaktImportFile
        ...
        :template-text="t('common.page.action.import.templatetext', { entity: t('entity.plant._self') })"
...
const searchPlaceholder = computed(
  () => t('common.page.form.placeholder.required', { field: t('entity.plant._self') }) + t('common.page.button.query')
)
...
const columns = computed<TableColumnsType>(() => [
  ...
  {
    title: t('entity.plant.sortorder'),
    dataIndex: 'sortOrder',
    key: 'entity.plant.sortorder',
    width: 120,
    resizable: true,
    ellipsis: true,
    customRender: ({ record }: { record: any }) => getPlantField(record, 'sortOrder') ?? ''
  },
  {
...
function handleUpdate() {
  if (selectedRow.value) {
    ...
    message.warning(t('common.page.action.warnselecttoaction', { action: t('common.page.button.edit'), entity: t('entity.plant._self') }))
  }
}
...
async function handleDeleteOne(record: Plant) {
  Modal.confirm({
    ...
    content: t('common.page.confirm.deleteentity', { entity: t('entity.plant._self'), name: t('common.page.action.thistarget', { target: t('entity.plant._self') }) }),
...
async function handleDelete() {
  if (selectedRows.value.length === 0) {
    message.warning(t('common.page.action.warnselecttoaction', { action: t('common.page.button.delete'), entity: t('entity.plant._self') }))
    return
  }
  Modal.confirm({
    title: t('common.page.action.confirmdelete'),
    content: t('common.page.confirm.deletecountentity', { entity: t('entity.plant._self'), count: selectedRows.value.length }),
    okText: t('common.page.button.delete'),
    cancelText: t('common.page.button.cancel'),
    onOk: async () => {
