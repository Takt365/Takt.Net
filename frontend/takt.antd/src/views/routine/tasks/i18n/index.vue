...
const translationListColumns = computed(() => [
  ...
  { title: t('entity.translation.sortOrder'), dataIndex: 'sortOrder', key: 'sortOrder', width: 80 },
...
const translationColumnsNested = computed<TableColumnsType>(() => [
  ...
  { title: t('entity.translation.sortOrder'), dataIndex: 'sortOrder', key: 'sortOrder', width: 100 }
])
...
const handleTranslationTransposedFormSubmit = async () => {
  ...
  try {
    ...
    const { resourceKey, resourceType, resourceGroup, sortOrder, remark, translations, translationIds, languageIds } = formData
    // 遍历所有语言，逐个创建/更新
