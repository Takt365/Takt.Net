<template>
  <div class="routine-announcement">
    <TaktQueryBar
      ...
      :placeholder="t('common.page.form.placeholder.search', { keyword: t('common.page.form.placeholder.keyword') })"
      :loading="loading"
      @search="handleSearch"
      @reset="handleReset"
    />
    ...
    >
      ...
      <a-form-item :label="t('entity.announcement.announcementstatus')">
        <a-select
          ...
          :placeholder="t('common.page.form.placeholder.select', { field: t('entity.announcement.announcementstatus') })"
          allow-clear
