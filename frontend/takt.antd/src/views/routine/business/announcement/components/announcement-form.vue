<template>
  ...
  >
    <a-tabs v-model:active-key="activeTab">
        ...
        <div class="announcement-form-pane">
          ...
          >
            <a-input
              ...
              :placeholder="t('common.page.form.placeholder.required', { field: t('entity.announcement.announcementcode') })"
          ...
          >
            <a-input
              ...
              :placeholder="t('common.page.form.placeholder.required', { field: t('entity.announcement.announcementtitle') })"
              allow-clear
            />
          </a-form-item>
          <a-form-item
          ...
          >
            <a-select
              ...
              :placeholder="t('common.page.form.placeholder.select', { field: t('entity.announcement.announcementtype') })"
      ...
      <a-tab-pane
        key="body"
        :tab="t('common.page.form.tabs.announcementbody')"
        force-render
      >
        <div class="announcement-form-pane">
          <a-form-item
          ...
          >
            <a-textarea
              ...
              :placeholder="t('common.page.form.placeholder.required', { field: t('entity.announcement.announcementcontent') })"
              :rows="10"
              allow-clear
            />
          </a-form-item>
      ...
      <a-tab-pane
        key="publish"
        :tab="t('common.page.form.tabs.announcementpublish')"
        force-render
      >
        <div class="announcement-form-pane">
          <a-form-item
          ...
          >
            <a-select
              ...
              :placeholder="t('common.page.form.placeholder.select', { field: t('entity.announcement.publishscope') })"
          ...
          >
            <a-date-picker
              ...
              :placeholder="t('common.page.form.placeholder.select', { field: t('entity.announcement.effectivetime') })"
              style="width: 100%"
              allow-clear
            />
          </a-form-item>
          ...
          <a-form-item
            :label="t('entity.announcement.sortorder')"
            name="sortOrder"
          >
            <a-input-number
              v-model:value="formState.sortOrder"
              :min="0"
              :placeholder="t('common.page.form.placeholder.required', { field: t('entity.announcement.ordernum') })"
              style="width: 100%"
            />
          </a-form-item>
        </div>
      ...
      <a-tab-pane
        key="other"
        :tab="t('common.page.form.tabs.announcementother')"
        force-render
      >
        <div class="announcement-form-pane">
          <a-form-item
...
const rules = computed<Record<string, Rule[]>>(() => ({
  announcementCode: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.announcement.announcementcode') }),
      trigger: 'blur'
    }
  ],
  announcementTitle: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.announcement.announcementtitle') }),
      trigger: 'blur'
    }
  ]
}))
