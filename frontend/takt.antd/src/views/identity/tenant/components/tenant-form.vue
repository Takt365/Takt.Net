        ...
        <a-col :span="12">
          ...
          >
            <a-input
              ...
              :placeholder="t('common.page.form.placeholder.required', { field: t('entity.tenant.tenantname') })"
              show-count
              :maxlength="50"
            />
          </a-form-item>
        ...
        <a-col :span="12">
          ...
          >
            <a-input
              ...
              :placeholder="t('common.page.form.placeholder.required', { field: t('entity.tenant.tenantcode') })"
        ...
        <a-col :span="12">
          ...
          >
            <a-input
              ...
              :placeholder="t('common.page.form.placeholder.required', { field: t('entity.tenant.configid') })"
              show-count
              :maxlength="20"
            />
          </a-form-item>
        ...
        <a-col :span="12">
          ...
          >
            <a-date-picker
              ...
              :placeholder="t('common.page.form.placeholder.select', { field: t('entity.tenant.starttime') })"
              style="width: 100%"
        ...
        <a-col :span="12">
          ...
          >
            <a-date-picker
              ...
              :placeholder="t('common.page.form.placeholder.select', { field: t('entity.tenant.endtime') })"
              style="width: 100%"
              value-format="YYYY-MM-DD"
              format="YYYY-MM-DD"
            />
...
const rules: Record<string, Rule[]> = {
  tenantName: [
    { required: true, message: t('common.page.form.placeholder.required', { field: t('entity.tenant.tenantname') }), trigger: 'blur' },
    { min: 2, max: 50, message: t('tenant.page.fields.tenantname.validation.format'), trigger: 'blur' }
  ],
  tenantCode: [
    { required: true, message: t('common.page.form.placeholder.required', { field: t('entity.tenant.tenantcode') }), trigger: 'blur' },
    { min: 2, max: 30, message: t('tenant.page.fields.tenantcode.validation.format'), trigger: 'blur' }
  ],
  configId: [
    { required: true, message: t('common.page.form.placeholder.required', { field: t('entity.tenant.configid') }), trigger: 'blur' }
  ]
}
