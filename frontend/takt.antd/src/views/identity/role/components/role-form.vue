...
const rules = computed<Record<string, Rule[]>>(() => ({
  roleName: [{ required: true, message: t('common.page.form.placeholder.required', { field: t('entity.role.name') }), trigger: 'blur' }],
  roleCode: [{ required: true, message: t('common.page.form.placeholder.required', { field: t('entity.role.code') }), trigger: 'blur' }],
  dataScope: [{ required: true, message: t('common.page.form.placeholder.select', { field: t('entity.role.datascope') }), trigger: 'change' }]
}))
