  ...
  <div class="identity-user">
    ...
    >
      <TaktImportFile
        ...
        :template-text="t('common.page.action.import.templatetext', { entity: t('entity.user._self') })"
        :upload-text="t('common.page.action.import.uploadtext')"
        :hint="t('common.page.action.import.hint')"
        :max-size="10"
        :max-rows="1000"
  ...
  CreateActionColumn<User>({
    actions: [
      ...
      },
      {
        ...
        label: t('common.page.button.allocate') + t('entity.rolemenu._self'),
        shape: 'plain',
      ...
      },
      {
        ...
        label: t('common.page.button.allocate') + t('entity.dept._self'),
        shape: 'plain',
        icon: RiBuildingLine,
        permission: 'identity:user:allocate',
        visible: (record) => !isAdminUser(record),
      ...
      },
      {
        ...
        label: t('common.page.button.allocate') + t('entity.post._self'),
        shape: 'plain',
...
const loadData = async () => {
  try {
    ...
    message.error(error.message || t('common.page.msg.loadfail'))
    dataSource.value = []
    total.value = 0
  } finally {
    loading.value = false
...
const handleEdit = (record: User) => {
  if (isAdminUser(record)) {
    message.warning(t('common.page.action.warnsubjectcannot', { subject: t('common.page.action.superuser'), action: t('common.page.button.update') }))
    return
  }
...
const handleUpdate = () => {
  if (selectedRow.value) {
    ...
    message.warning(t('common.page.action.warnselecttoaction', { action: t('common.page.button.edit'), entity: t('entity.user._self') }))
  }
}
...
const handleDeleteOne = (record: User) => {
  if (isAdminUser(record)) {
    message.warning(t('common.page.action.warnsubjectcannot', { subject: t('common.page.action.superuser'), action: t('common.page.button.delete') }))
    return
  }
  const userName = getUserField(record, 'userName') || t('common.page.action.thistarget', { target: t('entity.user._self') })
  Modal.confirm({
    title: t('common.page.action.confirmdelete'),
    content: t('common.page.confirm.deleteentity', { entity: t('entity.user._self'), name: userName }),
    ...
    onOk: async () => {
      try {
        ...
        message.error(error.message || t('common.page.msg.deletefail'))
      } finally {
        loading.value = false
      }
    }
...
const handleDelete = () => {
  if (selectedRows.value.length === 0) {
    message.warning(t('common.page.action.warnselecttoaction', { action: t('common.page.button.delete'), entity: t('entity.user._self') }))
    return
  }
  ...
  Modal.confirm({
    title: t('common.page.action.confirmdelete'),
    content: t('common.page.confirm.deletecountentity', { entity: t('entity.user._self'), count: selectedRows.value.length }),
    okText: t('common.page.button.delete'),
    cancelText: t('common.page.button.cancel'),
    onOk: async () => {
      try {
...
const handleRoleMenu = (record: User) => {
  ...
  if (isAdminUser(record)) {
    ...
    message.warning(t('common.page.action.warnsubjectcannot', { subject: t('common.page.action.superuser'), action: t('common.page.button.allocate') + t('entity.rolemenu._self') }))
    return
  }
...
const handleRole = (record: User) => {
  if (isAdminUser(record)) {
    message.warning(t('common.page.action.warnsubjectcannot', { subject: t('common.page.action.superuser'), action: t('common.page.button.allocate') + t('entity.role._self') }))
    return
  }
  currentAssignUser.value = record
...
const handleDept = (record: User) => {
  if (isAdminUser(record)) {
    message.warning(t('common.page.action.warnsubjectcannot', { subject: t('common.page.action.superuser'), action: t('common.page.button.allocate') + t('entity.dept._self') }))
    return
  }
  currentAssignUser.value = record
...
const handlePost = (record: User) => {
  if (isAdminUser(record)) {
    message.warning(t('common.page.action.warnsubjectcannot', { subject: t('common.page.action.superuser'), action: t('common.page.button.allocate') + t('entity.post._self') }))
    return
  }
  currentAssignUser.value = record
...
const handleTenant = (record: User) => {
  if (isAdminUser(record)) {
    message.warning(t('common.page.action.warnsubjectcannot', { subject: t('common.page.action.superuser'), action: t('common.page.button.allocate') + t('entity.tenant._self') }))
    return
  }
  currentAssignUser.value = record
...
const handleUpdatePassword = (record: User) => {
  if (isAdminUser(record)) {
    message.warning(t('common.page.action.warnsubjectcannot', { subject: t('common.page.action.superuser'), action: t('common.page.button.changepwd') }))
    return
  }
...
const handleChangePasswordSubmit = async () => {
  try {
    ...
    if (!currentChangePasswordUser.value) {
      message.error(t('common.page.msg.entitynotfound', { entity: t('entity.user._self') }))
      return
    }
    ...
    message.success(t('common.page.msg.actionsuccess', { action: t('common.page.button.changepwd') }))
    ...
    message.error(error.message || t('common.page.msg.actionfail', { action: t('common.page.button.changepwd') }))
  } finally {
...
const handleResetPassword = (record: User) => {
  if (isAdminUser(record)) {
    message.warning(t('common.page.action.warnsubjectcannot', { subject: t('common.page.action.superuser'), action: t('common.page.button.reset') + ' ' + t('common.page.button.password') }))
    return
  }
  const userName = getUserField(record, 'userName') || t('common.page.action.thistarget', { target: t('entity.user._self') })
  Modal.confirm({
    title: t('common.page.button.reset') + ' ' + t('common.page.button.password'),
    content: t('common.page.confirm.resetpwdcontent', { entity: t('entity.user._self'), name: userName }),
    ...
    onOk: async () => {
      try {
        ...
        message.success(t('common.page.msg.actionsuccess', { action: t('common.page.button.reset') + ' ' + t('common.page.button.password') }))
        loadData()
      } catch (error: any) {
        message.error(error.message || t('common.page.msg.actionfail', { action: t('common.page.button.reset') + ' ' + t('common.page.button.password') }))
      } finally {
        loading.value = false
      }
    }
...
const handleUnlock = (record: User) => {
  if (isAdminUser(record)) {
    message.warning(t('common.page.action.warnsubjectcannot', { subject: t('common.page.action.superuser'), action: t('common.page.button.unlock') }))
    return
  }
  const userName = getUserField(record, 'userName') || t('common.page.action.thistarget', { target: t('entity.user._self') })
  Modal.confirm({
    title: t('common.page.action.confirmaction', { action: t('common.page.button.unlock') }),
    content: t('common.page.confirm.unlockcontent', { entity: t('entity.user._self'), name: userName }),
    ...
    onOk: async () => {
      try {
        ...
        message.success(t('common.page.msg.actionsuccess', { action: t('common.page.button.unlock') }))
        loadData()
      } catch (error: any) {
        message.error(error.message || t('common.page.msg.actionfail', { action: t('common.page.button.unlock') }))
      } finally {
        loading.value = false
      }
    }
...
const handleExport = async () => {
  try {
    ...
    message.error(error.message || t('common.page.msg.exportfail'))
  } finally {
    loading.value = false
  }
}
  ...
  try {
    ...
    if (formData.value.userId) {
      ...
      if (currentUser && isAdminUser(currentUser)) {
        ...
        message.warning(t('common.page.action.warnusercannot', { name: userName, action: t('common.page.button.update') }))
    ...
    message.error(error.message || t('common.page.msg.operatefail'))
  } finally {
    formLoading.value = false
  }
}
