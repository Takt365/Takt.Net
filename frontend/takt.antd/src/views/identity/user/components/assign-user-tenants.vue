    ...
    >
      ...
      <a-form-item :label="t('entity.tenant._self')">
        <a-transfer
          ...
          :titles="[t('common.page.action.transferunassigned'), t('common.page.action.transferassigned')]"
          show-search
...
const loadUserTenants = async () => {
  ...
  try {
    ...
    message.error(getErrorMessage(error) || t('common.page.msg.loadtargetfail', { target: t('entity.user._self') + t('entity.tenant._self') }))
  } finally {
    loading.value = false
...
const handleSubmit = async () => {
  ...
  try {
    ...
    message.success(t('common.page.msg.assignsuccess', { target: t('entity.tenant._self') }))
    emit('success')
    handleCancel()
  } catch (error: unknown) {
    logger.error('[AssignUserTenants] 分配租户失败:', error)
    message.error(getErrorMessage(error) || t('common.page.msg.assignfail', { target: t('entity.tenant._self') }))
  } finally {
    loading.value = false
  }
}
