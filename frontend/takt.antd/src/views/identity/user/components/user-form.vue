...
<template>
  ...
  >
    <a-tabs v-model:active-key="activeTab">
            ...
            <a-col :span="12">
              ...
              >
                <a-input
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.user.email') })"
                  show-count
                  :maxlength="100"
                />
              </a-form-item>
            ...
            <a-col :span="12">
              ...
              >
                <a-input
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.user.phone') })"
                  show-count
                  :maxlength="20"
                />
              </a-form-item>
            ...
            <a-col :span="24">
              ...
              >
                <a-input-password
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.user.password') })"
                  show-count
                  :maxlength="20"
                />
              </a-form-item>
      ...
      <a-tab-pane
        key="permission"
        :tab="t('common.page.action.tabtargetallocation', { target: t('identity.user.page.tabs.permission') })"
        force-render
      >
        <div :class="formContentClass">
          <a-row :gutter="24">
            ...
            <a-col :span="24">
              <a-form-item :label="t('entity.tenant._self')">
                <TaktSelect
                  ...
                  :placeholder="t('common.page.form.placeholder.select', { field: t('entity.tenant._self') })"
                  multiple
                  :max-tag-count="'responsive'"
                />
              </a-form-item>
            ...
            <a-col :span="24">
              <a-form-item :label="t('entity.post._self')">
                <TaktSelect
                  ...
                  :options="postOptions"
                  :placeholder="t('common.page.form.placeholder.select', { field: t('entity.post._self') })"
                  multiple
                  :max-tag-count="'responsive'"
                />
              </a-form-item>
...
const loadBusinessOptions = async () => {
  try {
    ...
    logger.error('[User Form] 加载业务选项数据失败:', {
      error,
      message: error?.message || t('common.page.msg.loadoptionsfail'),
      stack: error?.stack
    })
    const errorMessage = error?.response?.data?.message || error?.message || t('common.page.msg.loadoptionsfail')
...
const rules = computed<Record<string, Rule[]>>(() => {
  ...
  return {
    ...
    userEmail: [
      {
        required: true,
        message: t('common.page.form.placeholder.required', { field: t('entity.user.email') }),
        trigger: 'blur'
      },
      {
        validator: (_rule: any, value: string) => {
    ...
    userPhone: [
      {
        required: true,
        message: t('common.page.form.placeholder.required', { field: t('entity.user.phone') }),
        trigger: 'blur'
      },
      {
        validator: (_rule: any, value: string) => {
    ...
    password: [
      {
        ...
        message: t('common.page.form.placeholder.required', { field: t('entity.user.password') }),
        trigger: 'blur'
      },
      {
        validator: (_rule: any, value: string) => {
