    ...
    >
      ...
      <a-form-item :label="t('entity.role._self')">
        <TaktSelect
          ...
          :placeholder="t('common.page.form.placeholder.selectfirst', { field: t('entity.role._self') })"
...
const loadUserRoles = async () => {
  ...
  try {
    ...
    if (!userId) {
      ...
      message.error(t('common.page.msg.entityidrequired', { entity: t('entity.user._self') }))
      return
    }
    ...
    message.error(error.message || t('common.page.msg.loadtargetfail', { target: t('entity.user._self') + t('entity.role._self') }))
  } finally {
...
const loadRoleMenus = async (roleId: string) => {
  try {
    ...
    message.error(error.message || t('common.page.msg.loadtargetfail', { target: t('entity.rolemenu._self') }))
  } finally {
...
const handleSubmit = async () => {
  ...
  if (!selectedRoleId.value) {
    message.warning(t('common.page.form.placeholder.selectfirst', { field: t('entity.role._self') }))
    return
  }
  ...
  try {
    ...
    message.success(t('common.page.msg.assignsuccess', { target: t('entity.rolemenu._self') }))
    emit('success')
    handleCancel()
  } catch (error: any) {
    logger.error('[AssignRoleMenus] 分配角色菜单失败:', error)
    message.error(error.message || t('common.page.msg.assignfail', { target: t('entity.rolemenu._self') }))
  } finally {
    loading.value = false
  }
}
