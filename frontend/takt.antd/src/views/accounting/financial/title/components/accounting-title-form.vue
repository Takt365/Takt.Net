      ...
      <div :class="formContentClass">
        ...
        >
            ...
            <a-col :span="12">
              ...
              >
                <a-input
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.accountingtitle.titlecode') })"
                  :maxlength="50"
            ...
            <a-col :span="12">
              ...
              >
                <a-input
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.accountingtitle.titlename') })"
                  :maxlength="100"
                  allow-clear
                />
              </a-form-item>
            ...
            <a-col :span="12">
              ...
              >
                <TaktTreeSelect
                  ...
                  :placeholder="t('common.page.form.placeholder.select', { field: t('entity.accountingtitle.parentid') })"
            ...
            <a-col :span="12">
              ...
              >
                <a-select
                  ...
                  :placeholder="t('common.page.form.placeholder.select', { field: t('entity.accountingtitle.titletype') })"
                />
              </a-form-item>
            </a-col>
          </a-row>
            ...
            <a-col :span="12">
              ...
              >
                <a-select
                  ...
                  :placeholder="t('common.page.form.placeholder.select', { field: t('entity.accountingtitle.balancedirection') })"
                />
              </a-form-item>
            </a-col>
            <a-col :span="12">
              ...
              >
                <a-select
                  ...
                  :placeholder="t('common.page.form.placeholder.select', { field: t('entity.accountingtitle.auxiliarytype') })"
                />
              </a-form-item>
            </a-col>
          </a-row>
          ...
          <a-row :gutter="24">
            ...
            <a-col :span="12">
              <a-form-item
                :label="t('entity.accountingtitle.sortorder')"
                name="sortOrder"
              >
                <a-input-number
...
const rules = computed<Record<string, Rule[]>>(() => ({
  titleCode: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.accountingtitle.titlecode') }),
      trigger: 'blur'
    }
  ],
  titleName: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.accountingtitle.titlename') }),
      trigger: 'blur'
    }
  ],
  titleType: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.accountingtitle.titletype') }),
      trigger: 'change'
    }
  ],
  balanceDirection: [
    {
      required: true,
      message: t('common.page.form.placeholder.select', { field: t('entity.accountingtitle.balancedirection') }),
      trigger: 'change'
    }
  ]
}))
  ...
  (newData) => {
    if (newData && Object.keys(newData).length > 0) {
      Object.assign(formState, {
        ...
        sortOrder: toNum(newData.sortOrder, 0),
