...
<template>
  <div class="accounting-financial-title">
    ...
    <TaktQueryBar
      ...
      :placeholder="t('common.page.form.placeholder.search', { keyword: t('entity.accountingtitle.keyword') })"
      :loading="loading"
      @search="handleSearch"
      @reset="handleReset"
    />
    ...
    <TaktModal
      ...
      :title="t('common.page.button.import') + t('entity.accountingtitle._self')"
      :width="600"
      :footer="null"
    ...
    >
      <TaktImportFile
        ...
        :template-text="t('common.page.action.import.templatetext', { entity: t('entity.accountingtitle._self') })"
...
function toYesNoText(value: unknown): string {
  return Number(value) === 1 ? t('common.page.button.yes') : t('common.page.button.no')
}
...
const columns = computed<TableColumnsType>(() => [
  ...
  },
  {
    ...
    width: 100,
    customRender: ({ record }: { record: AccountingTitle }) =>
      record.titleStatus === 0 ? t('common.page.button.enable') : t('common.page.button.disable')
  },
  {
    title: t('entity.accountingtitle.sortorder'),
    key: 'sortOrder',
    dataIndex: 'sortOrder',
    width: 100
  },
 ...
 */
const handleCreate = () => {
  formTitle.value = t('common.page.button.create') + t('entity.accountingtitle._self')
  formData.value = {}
...
const handleEdit = (record: AccountingTitle) => {
  formTitle.value = t('common.page.button.edit') + t('entity.accountingtitle._self')
