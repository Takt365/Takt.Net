...
<template>
  <div class="accounting-controlling-cost-center">
    ...
    <TaktQueryBar
      ...
      :placeholder="t('common.page.form.placeholder.search', { keyword: t('entity.costcenter.keyword') })"
      :loading="loading"
      @search="handleSearch"
      @reset="handleReset"
    />
    ...
    >
      <TaktImportFile
        ...
        :template-text="t('common.page.action.import.templatetext', { entity: t('entity.costcenter._self') })"
...
const columns = computed<TableColumnsType>(() => [
  ...
  {
    title: t('entity.costcenter.sortorder'),
    key: 'sortOrder',
    dataIndex: 'sortOrder',
    width: 100
  },
