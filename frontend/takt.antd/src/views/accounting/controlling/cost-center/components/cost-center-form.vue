            ...
            <a-col :span="12">
              ...
              >
                <a-input
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.costcenter.costcentercode') })"
                  show-count
                  :maxlength="50"
            ...
            <a-col :span="12">
              ...
              >
                <a-input
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.costcenter.costcentername') })"
                  show-count
                  :maxlength="100"
                  allow-clear
                />
            ...
            <a-col :span="12">
              ...
              >
                <a-select
                  ...
                  :placeholder="t('common.page.form.placeholder.select', { field: t('entity.costcenter.costcentertype') })"
                  allow-clear
                />
              </a-form-item>
            </a-col>
            ...
            <a-col :span="24">
              ...
              >
                <TaktTreeSelect
                  ...
                  :placeholder="t('common.page.form.placeholder.select', { field: t('entity.costcenter.deptid') })"
                  allow-clear
                  :field-names="{ label: 'dictLabel', value: 'dictValue' }"
                />
              </a-form-item>
...
const rules = computed<Record<string, Rule[]>>(() => ({
  costCenterCode: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.costcenter.costcentercode') }),
      trigger: 'blur'
    }
  ],
  costCenterName: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.costcenter.costcentername') }),
      trigger: 'blur'
    }
  ]
}))
