            ...
            <a-col :span="12">
              ...
              >
                <TaktSelect
                  ...
                  :placeholder="t('common.page.form.placeholder.select', { field: t('entity.leave.leavetype') })"
                  allow-clear
                  style="width: 100%"
                />
              </a-form-item>
            ...
            <a-col :span="24">
              ...
              >
                <a-textarea
                  ...
                  :placeholder="t('common.page.form.placeholder.optional', { field: t('entity.leave.reason') })"
                  :rows="3"
                  allow-clear
                />
              </a-form-item>
...
const rules = computed<Record<string, Rule[]>>(() => ({
  employeeId: [
    { required: true, message: t('common.page.form.placeholder.required', { field: t('entity.leave.employeeid') }), trigger: 'blur' }
  ],
  leaveType: [
    { required: true, message: t('common.page.form.placeholder.select', { field: t('entity.leave.leavetype') }), trigger: 'change' }
  ],
  startDate: [
    { required: true, message: t('common.page.form.placeholder.select', { field: t('entity.leave.startdate') }), trigger: 'change' }
  ],
  endDate: [
    { required: true, message: t('common.page.form.placeholder.select', { field: t('entity.leave.enddate') }), trigger: 'change' }
  ]
}))
