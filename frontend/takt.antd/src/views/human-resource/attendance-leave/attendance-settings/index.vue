  ...
  <div class="humanresource-attendance-leave-settings">
    ...
    >
      <TaktImportFile
        ...
        :template-text="t('common.page.action.import.templatetext', { entity: t('entity.attendancesetting._self') })"
...
const handleDeleteOne = (record: AttendanceSetting) => {
  Modal.confirm({
    ...
    content: t('common.page.confirm.deleteentity', { entity: entitySelf.value, name: getSettingId(record) }),
