  ...
  <div class="humanresource-attendance-leave-clockin">
    ...
    >
      <TaktImportFile
        ...
        :template-text="t('common.page.action.import.templatetext', { entity: t('entity.attendancepunch._self') })"
...
const handleDeleteOne = (record: AttendancePunch) => {
  Modal.confirm({
    ...
    content: t('common.page.confirm.deleteentity', { entity: entitySelf.value, name: getPunchId(record) }),
