  ...
  <div class="humanresource-attendance-leave-source">
    ...
    >
      <TaktImportFile
        ...
        :template-text="t('common.page.action.import.templatetext', { entity: t('entity.attendancesource._self') })"
...
const handleDeleteOne = (record: AttendanceSource) => {
  Modal.confirm({
    ...
    content: t('common.page.confirm.deleteentity', { entity: entitySelf.value, name: getSourceId(record) }),
