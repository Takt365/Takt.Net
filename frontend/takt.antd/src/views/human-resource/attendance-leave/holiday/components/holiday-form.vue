            ...
            <a-col :span="12">
              ...
              >
                <a-input
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.holiday.region') })"
                  show-count
                  :maxlength="10"
                />
              </a-form-item>
            ...
            <a-col :span="12">
              ...
              >
                <a-input
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.holiday.holidayname') })"
                  show-count
                  :maxlength="100"
                />
              </a-form-item>
            ...
            <a-col :span="12">
              ...
              >
                <TaktSelect
                  ...
                  :placeholder="t('common.page.form.placeholder.select', { field: t('entity.holiday.holidaytype') })"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
            ...
            <a-col :span="24">
              ...
              >
                <a-input
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.holiday.holidaygreeting') })"
                  allow-clear
                  show-count
                  :maxlength="200"
                />
            ...
            <a-col :span="24">
              ...
              >
                <a-textarea
                  ...
                  :placeholder="t('common.page.form.placeholder.optional', { field: t('entity.holiday.holidayquote') })"
                  :rows="2"
                  show-count
                  :maxlength="500"
                  allow-clear
...
const rules = computed<Record<string, Rule[]>>(() => ({
  region: [
    { required: true, message: t('common.page.form.placeholder.required', { field: t('entity.holiday.region') }), trigger: 'blur' }
  ],
  holidayName: [
    { required: true, message: t('common.page.form.placeholder.required', { field: t('entity.holiday.holidayname') }), trigger: 'blur' }
  ],
  holidayType: [
    { required: true, message: t('common.page.form.placeholder.select', { field: t('entity.holiday.holidaytype') }), trigger: 'change' }
  ],
  startDate: [
    { required: true, message: t('common.page.form.placeholder.select', { field: t('entity.holiday.startdate') }), trigger: 'change' }
  ],
  endDate: [
    { required: true, message: t('common.page.form.placeholder.select', { field: t('entity.holiday.enddate') }), trigger: 'change' }
  ],
  holidayTheme: [
    { required: true, message: t('common.page.form.placeholder.select', { field: t('entity.holiday.holidaytheme') }), trigger: 'change' }
  ]
}))
