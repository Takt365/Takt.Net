            ...
            <a-col :span="12">
              ...
              >
                <TaktSelect
                  ...
                  :placeholder="t('common.page.form.placeholder.select', { field: t('entity.dept.headid') })"
                  show-search
            ...
            <a-col :span="12">
              ...
              >
                <TaktSelect
                  ...
                  allow-clear
                  :placeholder="t('common.page.form.placeholder.select', { field: t('entity.dept.costcenter') })"
                  show-search
                  :field-names="{ label: 'dictLabel', value: 'dictValue' }"
                />
              </a-form-item>
            ...
            <a-col :span="24">
              ...
              >
                <TaktSelect
                  ...
                  multiple
                  allow-clear
                  :placeholder="t('common.page.form.placeholder.select', { field: t('entity.dept.delegate') })"
                  show-search
                  :field-names="{ label: 'dictLabel', value: 'dictValue', extLabel: 'extLabel' }"
                />
              </a-form-item>
...
const rules = computed<Record<string, Rule[]>>(() => ({
  ...
  deptType: [{ required: true, message: t('common.page.form.placeholder.select', { field: t('entity.dept.type') }), trigger: 'change' }],
  dataScope: [{ required: true, message: t('common.page.form.placeholder.select', { field: t('entity.dept.datascope') }), trigger: 'change' }],
  deptHeadId: [{ required: true, message: t('common.page.form.placeholder.select', { field: t('entity.dept.headid') }), trigger: 'change' }]
}))
