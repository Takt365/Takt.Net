...
const rules = computed<Record<string, Rule[]>>(() => ({
  postName: [{ required: true, message: t('common.page.form.placeholder.required', { field: t('entity.post.postName') }), trigger: 'blur' }],
  postCode: [{ required: true, message: t('common.page.form.placeholder.required', { field: t('entity.post.postCode') }), trigger: 'blur' }],
  deptId: [{ required: true, message: t('common.page.form.placeholder.select', { field: t('entity.post.deptId') }), trigger: 'change' }],
  postLevel: [{ required: true, message: t('common.page.form.placeholder.required', { field: t('entity.post.postLevel') }), trigger: 'blur' }],
  dataScope: [{ required: true, message: t('common.page.form.placeholder.select', { field: t('entity.post.dataScope') }), trigger: 'change' }]
}))
