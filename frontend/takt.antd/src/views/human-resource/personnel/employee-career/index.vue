...
<template>
  <div class="humanresource-personnel-employee-career">
    ...
    >
      <TaktImportFile
        file-type="xlsx"
        :sheet-name="t('common.page.action.import.sheetnametemplate', { entity: t('entity.employeecareer._self') })"
        :template-file-name="t('common.page.action.import.sheetnametemplate', { entity: t('entity.employeecareer._self') })"
        template-permission="humanresource:personnel:employeecareer:template"
        import-permission="humanresource:personnel:employeecareer:import"
        :download-template="handleDownloadTemplate"
        :import-file="handleImportFile"
        :template-text="t('common.page.action.import.templatetext', { entity: t('entity.employeecareer._self') })"
