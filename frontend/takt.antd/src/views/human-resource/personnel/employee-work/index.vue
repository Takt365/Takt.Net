...
<template>
  <div class="humanresource-personnel-employee-work">
    ...
    >
      <TaktImportFile
        file-type="xlsx"
        :sheet-name="t('common.page.action.import.sheetnametemplate', { entity: t('entity.employeework._self') })"
        :template-file-name="t('common.page.action.import.sheetnametemplate', { entity: t('entity.employeework._self') })"
        template-permission="humanresource:personnel:employeework:template"
        import-permission="humanresource:personnel:employeework:import"
        :download-template="handleDownloadTemplate"
        :import-file="handleImportFile"
        :template-text="t('common.page.action.import.templatetext', { entity: t('entity.employeework._self') })"
