  ...
  <div class="humanresource-personnel-employee">
    ...
    >
      <TaktImportFile
        ...
        :template-text="t('common.page.action.import.templatetext', { entity: t('entity.employee._self') })"
...
const handleDeleteOne = (record: Employee) => {
  ...
  Modal.confirm({
    ...
    content: t('common.page.confirm.deleteentity', { entity: t('entity.employee._self'), name }),
