            ...
            <a-col :span="12">
              ...
              >
                <a-input
                  ...
                  :placeholder="t('common.page.form.placeholder.required', { field: t('entity.employee.realname') })"
                  allow-clear
                />
              </a-form-item>
            </a-col>
            ...
            <a-col :span="12">
              ...
              >
                <TaktSelect
                  ...
                  :placeholder="t('common.page.form.placeholder.select', { field: t('entity.employee.gender') })"
                />
              </a-form-item>
            </a-col>
          </a-row>
            ...
            <a-col :span="12">
              ...
              >
                <TaktSelect
                  ...
                  :placeholder="t('common.page.form.placeholder.select', { field: t('entity.employee.maritalstatus') })"
                />
              </a-form-item>
            </a-col>
          </a-row>
            ...
            <a-col :span="12">
              ...
              >
                <TaktSelect
                  ...
                  :placeholder="t('common.page.form.placeholder.select', { field: t('entity.employee.employeestatus') })"
                />
              </a-form-item>
            </a-col>
          </a-row>
...
const employeeCodePlaceholder = computed(() => {
  if (props.isEdit) {
    return t('common.page.form.placeholder.required', { field: t('entity.employee.code') })
  }
...
const rules = computed<Record<string, Rule[]>>(() => ({
      ...
      validator: async (_rule, value) => {
        ...
        if (value === undefined || value === null || String(value).trim() === '') {
          return Promise.reject(
            new Error(t('common.page.form.placeholder.required', { field: t('entity.employee.code') }))
          )
        }
  ...
  realName: [
    {
      required: true,
      message: t('common.page.form.placeholder.required', { field: t('entity.employee.realname') }),
      trigger: 'blur'
    }
  ],
  gender: [
