...
<template>
  <div class="humanresource-personnel-employee-education">
    ...
    <TaktQueryBar
      ...
      :placeholder="t('common.page.form.placeholder.search', { keyword: t('entity.employeeeducation.schoolName') })"
      :loading="loading"
      @search="handleSearch"
      @reset="handleReset"
    />
    ...
    >
      <TaktImportFile
        file-type="xlsx"
        :sheet-name="t('common.page.action.import.sheetnametemplate', { entity: t('entity.employeeeducation._self') })"
        :template-file-name="t('common.page.action.import.sheetnametemplate', { entity: t('entity.employeeeducation._self') })"
        template-permission="humanresource:personnel:employeeeducation:template"
        import-permission="humanresource:personnel:employeeeducation:import"
        :download-template="handleDownloadTemplate"
        :import-file="handleImportFile"
        :template-text="t('common.page.action.import.templatetext', { entity: t('entity.employeeeducation._self') })"
...
const columns = computed<TableColumnsType>(() => [
  ...
  CreateActionColumn<EmployeeEducation>({
    actions: [
      {
        key: 'update',
