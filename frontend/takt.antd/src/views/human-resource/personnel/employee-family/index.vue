...
<template>
  <div class="humanresource-personnel-employee-family">
    ...
    <TaktQueryBar
      ...
      :placeholder="t('common.form.placeholder.search', { keyword: t('entity.employeefamily.memberName') })"
      :loading="loading"
      @search="handleSearch"
      @reset="handleReset"
    />
    ...
    >
      <FamilyForm ref="formRef" :form-data="formData" :loading="formLoading" />
    </TaktModal>
    ...
    >
      ...
      <a-form-item :label="t('entity.employeefamily.relationType')">
        <a-input-number v-model:value="advancedQueryForm.relationType" :min="0" style="width: 100%" />
      </a-form-item>
    </TaktQueryDrawer>
    ...
    <TaktModal
      ...
      :title="t('common.button.import') + t('entity.employeefamily._self')"
      :width="600"
      :footer="null"
    ...
    >
      <TaktImportFile
        file-type="xlsx"
        :sheet-name="t('common.action.import.sheetNameTemplate', { entity: t('entity.employeefamily._self') })"
        :template-file-name="t('common.action.import.sheetNameTemplate', { entity: t('entity.employeefamily._self') })"
        template-permission="humanresource:personnel:employeefamily:template"
        import-permission="humanresource:personnel:employeefamily:import"
        :download-template="handleDownloadTemplate"
        :import-file="handleImportFile"
        :template-text="t('common.action.import.templateText', { entity: t('entity.employeefamily._self') })"
