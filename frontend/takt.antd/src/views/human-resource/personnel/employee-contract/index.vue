...
<template>
  <div class="humanresource-personnel-employee-contract">
    ...
    <TaktQueryBar
      ...
      :placeholder="t('common.form.placeholder.search', { keyword: t('entity.employeecontract.contractNo') })"
      :loading="loading"
      @search="handleSearch"
      @reset="handleReset"
    />
    ...
    >
      <ContractForm ref="formRef" :form-data="formData" :loading="formLoading" />
    </TaktModal>
    ...
    >
      ...
      <a-form-item :label="t('entity.employeecontract.contractStatus')">
        <a-input-number v-model:value="advancedQueryForm.contractStatus" :min="0" style="width: 100%" />
      </a-form-item>
    </TaktQueryDrawer>
    ...
    <TaktModal
      ...
      :title="t('common.button.import') + t('entity.employeecontract._self')"
      :width="600"
      :footer="null"
    ...
    >
      <TaktImportFile
        file-type="xlsx"
        :sheet-name="t('common.action.import.sheetNameTemplate', { entity: t('entity.employeecontract._self') })"
        :template-file-name="t('common.action.import.sheetNameTemplate', { entity: t('entity.employeecontract._self') })"
        template-permission="humanresource:personnel:employeecontract:template"
        import-permission="humanresource:personnel:employeecontract:import"
        :download-template="handleDownloadTemplate"
        :import-file="handleImportFile"
        :template-text="t('common.action.import.templateText', { entity: t('entity.employeecontract._self') })"
