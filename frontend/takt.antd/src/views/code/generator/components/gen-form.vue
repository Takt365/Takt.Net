...
import type { GenTable } from '@/types/code/generator/code-generator-specific'
import { getColumnsByTableId } from '@/api/code/generator/gen-table-column'
import { getDefaultGenPath } from '@/api/code/generator/code-generator-specific'
import { getDatabaseConfigs, getDatabaseTablesWithGenerator } from '@/api/code/generator/code-generator-specific'
...
/** 是否编辑模式:只判断主表 ID —— 有 genTableId 为编辑,无则为新增(watch 已把 formData.id 并入 formState.genTableId) */
