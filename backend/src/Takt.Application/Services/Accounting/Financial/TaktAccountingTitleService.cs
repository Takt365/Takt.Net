...
public class TaktAccountingTitleService : TaktServiceBase, ITaktAccountingTitleService
{
    ...
    {
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.TitleCode, dto.TitleCode, null, $"会计科目表编码 {dto.TitleCode} 已存在");
    ...
    public async Task<TaktAccountingTitleDto> UpdateAccountingTitleAsync(long id, TaktAccountingTitleUpdateDto dto)
    {
        ...
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.TitleCode, dto.TitleCode, id, $"会计科目表编码 {dto.TitleCode} 已存在");
