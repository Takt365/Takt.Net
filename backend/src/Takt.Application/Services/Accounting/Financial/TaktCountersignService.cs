...
public class TaktCountersignService : TaktServiceBase, ITaktCountersignService
{
    ...
    {
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.CountersignCode, dto.CountersignCode, null, $"会签单表编码 {dto.CountersignCode} 已存在");
    ...
    public async Task<TaktCountersignDto> UpdateCountersignAsync(long id, TaktCountersignUpdateDto dto)
    {
        ...
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.CountersignCode, dto.CountersignCode, id, $"会签单表编码 {dto.CountersignCode} 已存在");
