...
public interface ITaktCostCenterService
{
    ...
    Task<TaktPagedResult<TaktCostCenterDto>> GetListAsync(TaktCostCenterQueryDto queryDto);
    ...
    Task<TaktCostCenterDto?> GetByIdAsync(long id);
    ...
    /// <returns>成本中心DTO</returns>
    Task<TaktCostCenterDto> CreateAsync(TaktCostCenterCreateDto dto);
    ...
    /// <returns>成本中心DTO</returns>
    Task<TaktCostCenterDto> UpdateAsync(long id, TaktCostCenterUpdateDto dto);
    ...
    /// <returns>成本中心DTO</returns>
    Task<TaktCostCenterDto> UpdateStatusAsync(TaktCostCenterStatusDto dto);
    ...
    Task<(string fileName, byte[] content)> ExportAsync(TaktCostCenterQueryDto query, string? sheetName, string? fileName);
}
