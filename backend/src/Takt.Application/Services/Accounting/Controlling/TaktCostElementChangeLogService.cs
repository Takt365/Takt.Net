...
public class TaktCostElementChangeLogService : TaktServiceBase, ITaktCostElementChangeLogService
{
    ...
    {
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.CostElementCode, dto.CostElementCode, null, $"成本要素变更记录表编码 {dto.CostElementCode} 已存在");
    ...
    public async Task<TaktCostElementChangeLogDto> UpdateCostElementChangeLogAsync(long id, TaktCostElementChangeLogUpdateDto dto)
    {
        ...
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.CostElementCode, dto.CostElementCode, id, $"成本要素变更记录表编码 {dto.CostElementCode} 已存在");
