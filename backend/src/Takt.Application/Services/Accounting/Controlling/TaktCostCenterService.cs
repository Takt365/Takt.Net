...
public class TaktCostCenterService : TaktServiceBase, ITaktCostCenterService
{
    ...
    {
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.CostCenterCode, dto.CostCenterCode, null, $"成本中心表编码 {dto.CostCenterCode} 已存在");
    ...
    public async Task<TaktCostCenterDto> UpdateCostCenterAsync(long id, TaktCostCenterUpdateDto dto)
    {
        ...
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.CostCenterCode, dto.CostCenterCode, id, $"成本中心表编码 {dto.CostCenterCode} 已存在");
