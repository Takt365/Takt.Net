...
public class TaktFlowFormService : TaktServiceBase, ITaktFlowFormService
{
    ...
    {
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.FormCode, dto.FormCode, null, $"流程表单表编码 {dto.FormCode} 已存在");
    ...
    public async Task<TaktFlowFormDto> UpdateFlowFormAsync(long id, TaktFlowFormUpdateDto dto)
    {
        ...
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.FormCode, dto.FormCode, id, $"流程表单表编码 {dto.FormCode} 已存在");
