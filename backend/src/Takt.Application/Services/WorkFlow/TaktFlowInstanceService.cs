...
public class TaktFlowInstanceService : TaktServiceBase, ITaktFlowInstanceService
{
    ...
    {
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.InstanceCode, dto.InstanceCode, null, $"流程实例表编码 {dto.InstanceCode} 已存在");
    ...
    public async Task<TaktFlowInstanceDto> UpdateFlowInstanceAsync(long id, TaktFlowInstanceUpdateDto dto)
    {
        ...
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.InstanceCode, dto.InstanceCode, id, $"流程实例表编码 {dto.InstanceCode} 已存在");
