...
public class TaktMenuService : TaktServiceBase, ITaktMenuService
{
    ...
    {
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.MenuCode, dto.MenuCode, null, $"菜单信息表编码 {dto.MenuCode} 已存在");
    ...
    public async Task<TaktMenuDto> UpdateMenuAsync(long id, TaktMenuUpdateDto dto)
    {
        ...
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.MenuCode, dto.MenuCode, id, $"菜单信息表编码 {dto.MenuCode} 已存在");
