...
public interface ITaktTenantService
{
    ...
    Task<TaktPagedResult<TaktTenantDto>> GetListAsync(TaktTenantQueryDto queryDto);
    ...
    Task<TaktTenantDto?> GetByIdAsync(long id);
    ...
    /// <returns>租户DTO</returns>
    Task<TaktTenantDto> CreateAsync(TaktTenantCreateDto dto);
    ...
    /// <returns>租户DTO</returns>
    Task<TaktTenantDto> UpdateAsync(long id, TaktTenantUpdateDto dto);
    ...
    /// <returns>租户DTO</returns>
    Task<TaktTenantDto> UpdateStatusAsync(TaktTenantStatusDto dto);
    ...
    Task<(string fileName, byte[] content)> ExportAsync(TaktTenantQueryDto query, string? sheetName, string? fileName);
}
