...
public interface ITaktDictTypeService
{
    ...
    Task<TaktPagedResult<TaktDictTypeDto>> GetListAsync(TaktDictTypeQueryDto queryDto);
    ...
    /// <returns>字典类型DTO</returns>
    Task<TaktDictTypeDto> CreateAsync(TaktDictTypeCreateDto dto);
    ...
    /// <returns>字典类型DTO</returns>
    Task<TaktDictTypeDto> UpdateAsync(long id, TaktDictTypeUpdateDto dto);
    ...
    /// <returns>字典类型DTO</returns>
    Task<TaktDictTypeDto> UpdateStatusAsync(TaktDictTypeStatusDto dto);
    ...
    Task<(string fileName, byte[] content)> ExportAsync(TaktDictTypeQueryDto query, string? sheetName, string? fileName);
}