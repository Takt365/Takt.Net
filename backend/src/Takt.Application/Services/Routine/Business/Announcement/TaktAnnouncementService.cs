...
public class TaktAnnouncementService : TaktServiceBase, ITaktAnnouncementService
{
    ...
    {
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.AnnouncementCode, dto.AnnouncementCode, null, $"公告表编码 {dto.AnnouncementCode} 已存在");
    ...
    public async Task<TaktAnnouncementDto> UpdateAnnouncementAsync(long id, TaktAnnouncementUpdateDto dto)
    {
        ...
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.AnnouncementCode, dto.AnnouncementCode, id, $"公告表编码 {dto.AnnouncementCode} 已存在");
