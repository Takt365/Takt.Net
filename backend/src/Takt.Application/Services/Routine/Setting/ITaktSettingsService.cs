...
public interface ITaktSettingsService
{
    ...
    Task<TaktPagedResult<TaktSettingsDto>> GetListAsync(TaktSettingsQueryDto queryDto);
    ...
    Task<TaktSettingsDto?> GetByIdAsync(long id);
    ...
    /// <returns>设置DTO</returns>
    Task<TaktSettingsDto> CreateAsync(TaktSettingsCreateDto dto);
    ...
    /// <returns>设置DTO</returns>
    Task<TaktSettingsDto> UpdateAsync(long id, TaktSettingsUpdateDto dto);
    ...
    /// <returns>设置DTO</returns>
    Task<TaktSettingsDto> UpdateStatusAsync(TaktSettingsStatusDto dto);
    ...
    Task<(string fileName, byte[] content)> ExportAsync(TaktSettingsQueryDto query, string? sheetName, string? fileName);
}