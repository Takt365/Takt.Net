...
public interface ITaktTranslationService
{
    ...
    Task<TaktPagedResult<TaktTranslationDto>> GetListAsync(TaktTranslationQueryDto queryDto);
    ...
    Task<TaktTranslationTransposedResult> GetListTransposedAsync(TaktTranslationQueryDto queryDto);
    ...
    Task<TaktTranslationDto?> GetByIdAsync(long id);
    ...
    /// <returns>翻译DTO</returns>
    Task<TaktTranslationDto> CreateAsync(TaktTranslationCreateDto dto);
    ...
    /// <returns>翻译DTO</returns>
    Task<TaktTranslationDto> UpdateAsync(long id, TaktTranslationUpdateDto dto);
    ...
    Task<(string fileName, byte[] content)> ExportAsync(TaktTranslationQueryDto query, string? sheetName, string? fileName);
}
