...
public interface ITaktLanguageService
{
    ...
    Task<TaktPagedResult<TaktLanguageDto>> GetListAsync(TaktLanguageQueryDto queryDto);
    ...
    Task<TaktLanguageDto?> GetByIdAsync(long id);
    ...
    /// <returns>语言DTO</returns>
    Task<TaktLanguageDto> CreateAsync(TaktLanguageCreateDto dto);
    ...
    /// <returns>语言DTO</returns>
    Task<TaktLanguageDto> UpdateAsync(long id, TaktLanguageUpdateDto dto);
    ...
    /// <returns>语言DTO</returns>
    Task<TaktLanguageDto> UpdateStatusAsync(TaktLanguageStatusDto dto);
    ...
    Task<(string fileName, byte[] content)> ExportAsync(TaktLanguageQueryDto query, string? sheetName, string? fileName);
}
