...
public class TaktDictTypeService : TaktServiceBase, ITaktDictTypeService
{
    ...
    {
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.DictTypeCode, dto.DictTypeCode, null, $"字典类型表编码 {dto.DictTypeCode} 已存在");
    ...
    public async Task<TaktDictTypeDto> UpdateDictTypeAsync(long id, TaktDictTypeUpdateDto dto)
    {
        ...
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.DictTypeCode, dto.DictTypeCode, id, $"字典类型表编码 {dto.DictTypeCode} 已存在");
