...
public class TaktFileService : TaktServiceBase, ITaktFileService
{
    ...
    {
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.FileCode, dto.FileCode, null, $"文件表编码 {dto.FileCode} 已存在");
    ...
    public async Task<TaktFileDto> UpdateFileAsync(long id, TaktFileUpdateDto dto)
    {
        ...
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.FileCode, dto.FileCode, id, $"文件表编码 {dto.FileCode} 已存在");
