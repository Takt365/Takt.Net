...
public class TaktPerformanceIndicatorService : TaktServiceBase, ITaktPerformanceIndicatorService
{
    ...
    {
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.IndicatorCode, dto.IndicatorCode, null, $"绩效指标表编码 {dto.IndicatorCode} 已存在");
    ...
    public async Task<TaktPerformanceIndicatorDto> UpdatePerformanceIndicatorAsync(long id, TaktPerformanceIndicatorUpdateDto dto)
    {
        ...
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.IndicatorCode, dto.IndicatorCode, id, $"绩效指标表编码 {dto.IndicatorCode} 已存在");
