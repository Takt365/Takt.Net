...
public class TaktEmployeeAttachmentService : TaktServiceBase, ITaktEmployeeAttachmentService
{
    ...
    {
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.FileCode, dto.FileCode, null, $"员工附件表编码 {dto.FileCode} 已存在");
    ...
    public async Task<TaktEmployeeAttachmentDto> UpdateEmployeeAttachmentAsync(long id, TaktEmployeeAttachmentUpdateDto dto)
    {
        ...
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.FileCode, dto.FileCode, id, $"员工附件表编码 {dto.FileCode} 已存在");
