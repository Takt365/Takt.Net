...
// 创建时间：2026-05-11
// 创建人：Takt365
// 功能描述：员工业务技能表应用服务接口，定义EmployeeSkill管理的业务操作
// 
...
public interface ITaktEmployeeSkillService
{
    ...
    /// 根据ID获取员工业务技能表
    /// </summary>
    /// <param name="id">员工业务技能表ID</param>
    /// <returns>员工业务技能表DTO</returns>
    Task<TaktEmployeeSkillDto?> GetEmployeeSkillByIdAsync(long id);

    /// <summary>
    /// 获取员工业务技能表选项列表（用于下拉框等）
    /// </summary>
    /// <returns>员工业务技能表选项列表</returns>
    Task<List<TaktSelectOption>> GetEmployeeSkillOptionsAsync();

    /// <summary>
    /// 创建员工业务技能表
    /// </summary>
    /// <param name="dto">创建员工业务技能表DTO</param>
    /// <returns>员工业务技能表DTO</returns>
    ...
    /// </summary>
    /// <param name="id">员工业务技能表ID</param>
    /// <param name="dto">更新员工业务技能表DTO</param>
    /// <returns>员工业务技能表DTO</returns>
    ...
    /// </summary>
    /// <param name="query">员工业务技能表(EmployeeSkill)查询DTO（包含查询条件）</param>
    /// <param name="sheetName">工作表名称</param>
    /// <param name="fileName">文件名</param>
