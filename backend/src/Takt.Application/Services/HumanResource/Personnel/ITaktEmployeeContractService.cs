...
// 创建时间：2026-05-11
// 创建人：Takt365
// 功能描述：员工合同表应用服务接口，定义EmployeeContract管理的业务操作
// 
...
public interface ITaktEmployeeContractService
{
    ...
    /// </summary>
    /// <param name="id">员工合同表ID</param>
    /// <param name="dto">更新员工合同表DTO</param>
    /// <returns>员工合同表DTO</returns>
    ...
    /// <summary>
    /// 更新员工合同表(EmployeeContract)ContractStatus
    /// </summary>
    /// <param name="dto">员工合同表(EmployeeContract)ContractStatusDTO</param>
    /// <returns>员工合同表(EmployeeContract)DTO</returns>
    Task<TaktEmployeeContractDto> UpdateEmployeeContractContractStatusAsync(TaktEmployeeContractContractStatusDto dto);
    ...
    /// </summary>
    /// <param name="query">员工合同表(EmployeeContract)查询DTO（包含查询条件）</param>
    /// <param name="sheetName">工作表名称</param>
    /// <param name="fileName">文件名</param>
