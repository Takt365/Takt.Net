...
// 创建时间：2026-05-11
// 创建人：Takt365
// 功能描述：员工职业表应用服务接口，定义EmployeeCareer管理的业务操作
// 
...
public interface ITaktEmployeeCareerService
{
    ...
    /// 根据ID获取员工职业表
    /// </summary>
    /// <param name="id">员工职业表ID</param>
    /// <returns>员工职业表DTO</returns>
    Task<TaktEmployeeCareerDto?> GetEmployeeCareerByIdAsync(long id);

    /// <summary>
    /// 获取员工职业表选项列表（用于下拉框等）
    /// </summary>
    /// <returns>员工职业表选项列表</returns>
    Task<List<TaktSelectOption>> GetEmployeeCareerOptionsAsync();

    /// <summary>
    /// 创建员工职业表
    /// </summary>
    /// <param name="dto">创建员工职业表DTO</param>
    /// <returns>员工职业表DTO</returns>
    ...
    /// </summary>
    /// <param name="id">员工职业表ID</param>
    /// <param name="dto">更新员工职业表DTO</param>
    /// <returns>员工职业表DTO</returns>
    ...
    /// </summary>
    /// <param name="query">员工职业表(EmployeeCareer)查询DTO（包含查询条件）</param>
    /// <param name="sheetName">工作表名称</param>
    /// <param name="fileName">文件名</param>
