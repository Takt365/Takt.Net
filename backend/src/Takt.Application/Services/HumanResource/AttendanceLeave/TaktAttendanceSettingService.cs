...
public class TaktAttendanceSettingService : TaktServiceBase, ITaktAttendanceSettingService
{
    ...
    {
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.SettingCode, dto.SettingCode, null, $"考勤设置表编码 {dto.SettingCode} 已存在");
    ...
    public async Task<TaktAttendanceSettingDto> UpdateAttendanceSettingAsync(long id, TaktAttendanceSettingUpdateDto dto)
    {
        ...
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.SettingCode, dto.SettingCode, id, $"考勤设置表编码 {dto.SettingCode} 已存在");
