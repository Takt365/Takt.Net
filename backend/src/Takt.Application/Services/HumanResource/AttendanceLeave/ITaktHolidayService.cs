...
public interface ITaktHolidayService
{
    ...
    Task<TaktPagedResult<TaktHolidayDto>> GetListAsync(TaktHolidayQueryDto queryDto);
    ...
    Task<TaktHolidayDto?> GetByIdAsync(long id);
    ...
    Task<List<TaktSelectOption>> GetOptionsAsync(string? region = null);
    ...
    /// <returns>假日DTO</returns>
    Task<TaktHolidayDto> CreateAsync(TaktHolidayCreateDto dto);
    ...
    /// <returns>假日DTO</returns>
    Task<TaktHolidayDto> UpdateAsync(long id, TaktHolidayUpdateDto dto);
    ...
    Task<(string fileName, byte[] content)> ExportAsync(TaktHolidayQueryDto query, string? sheetName, string? fileName);
