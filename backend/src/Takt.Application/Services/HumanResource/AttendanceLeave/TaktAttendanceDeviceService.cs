...
public class TaktAttendanceDeviceService : TaktServiceBase, ITaktAttendanceDeviceService
{
    ...
    {
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.DeviceCode, dto.DeviceCode, null, $"考勤设备表编码 {dto.DeviceCode} 已存在");
    ...
    public async Task<TaktAttendanceDeviceDto> UpdateAttendanceDeviceAsync(long id, TaktAttendanceDeviceUpdateDto dto)
    {
        ...
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.DeviceCode, dto.DeviceCode, id, $"考勤设备表编码 {dto.DeviceCode} 已存在");
