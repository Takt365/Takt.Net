...
public interface ITaktLeaveService
{
    ...
    Task<TaktPagedResult<TaktLeaveDto>> GetListAsync(TaktLeaveQueryDto queryDto);
    ...
    Task<TaktLeaveDto?> GetByIdAsync(long id);
    ...
    Task<TaktLeaveDto> CreateAsync(TaktLeaveCreateDto dto);
    ...
    Task<TaktLeaveDto> UpdateAsync(long id, TaktLeaveUpdateDto dto);
    ...
    Task<TaktLeaveDto> UpdateStatusAsync(TaktLeaveStatusDto dto);
    ...
    Task<(string fileName, byte[] content)> ExportAsync(TaktLeaveQueryDto query, string? sheetName, string? fileName);
