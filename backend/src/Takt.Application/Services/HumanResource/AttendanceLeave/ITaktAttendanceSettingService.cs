...
public interface ITaktAttendanceSettingService
{
    ...
    /// 根据ID获取考勤设置表
    /// </summary>
    /// <param name="id">考勤设置表ID</param>
    /// <returns>考勤设置表DTO</returns>
    Task<TaktAttendanceSettingDto?> GetAttendanceSettingByIdAsync(long id);

    /// <summary>
    /// 获取考勤设置表选项列表（用于下拉框等）
    /// </summary>
    /// <returns>考勤设置表选项列表</returns>
    Task<List<TaktSelectOption>> GetAttendanceSettingOptionsAsync();

    /// <summary>
    /// 创建考勤设置表
    /// </summary>
    /// <param name="dto">创建考勤设置表DTO</param>
    /// <returns>考勤设置表DTO</returns>
    ...
    /// </summary>
    /// <param name="id">考勤设置表ID</param>
    /// <param name="dto">更新考勤设置表DTO</param>
    /// <returns>考勤设置表DTO</returns>
    ...
    Task<TaktAttendanceSettingDto> UpdateAttendanceSettingSortAsync(TaktAttendanceSettingSortDto dto);
    ...
    /// </summary>
    /// <param name="query">考勤设置表(AttendanceSetting)查询DTO（包含查询条件）</param>
    /// <param name="sheetName">工作表名称</param>
    /// <param name="fileName">文件名</param>
