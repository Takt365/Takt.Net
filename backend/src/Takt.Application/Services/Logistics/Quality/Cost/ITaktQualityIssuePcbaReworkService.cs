...
// 创建时间：2026-05-10
// 创建人：Takt365
// 功能描述：质量问题PCBA不良改修费用明细表应用服务接口（主子表），定义QualityIssuePcbaRework管理的业务操作
// 
...
/// <summary>
/// 质量问题PCBA不良改修费用明细表应用服务接口（主子表）
/// </summary>
public interface ITaktQualityIssuePcbaReworkService
{
    /// <summary>
    /// 获取质量问题PCBA不良改修费用明细表列表（分页）
    /// </summary>
    ...
    /// <summary>
    /// 批量删除质量问题PCBA不良改修费用明细表(QualityIssuePcbaRework)（级联删除子表）
    /// </summary>
    ...
    Task<(string fileName, byte[] content)> GetQualityIssuePcbaReworkTemplateAsync(string? sheetName, string? fileName);
    ...
    Task<(int success, int fail, List<string> errors)> ImportQualityIssuePcbaReworkAsync(Stream fileStream, string? sheetName);

    /// <summary>
    /// 导出质量问题PCBA不良改修费用明细表(QualityIssuePcbaRework)
    /// </summary>
    /// <param name="query">质量问题PCBA不良改修费用明细表(QualityIssuePcbaRework)查询DTO（包含查询条件）</param>
    /// <param name="sheetName">工作表名称</param>
    /// <param name="fileName">文件名</param>
    /// <returns>Excel文件信息（文件名和内容）</returns>
    Task<(string fileName, byte[] content)> ExportQualityIssuePcbaReworkAsync(TaktQualityIssuePcbaReworkQueryDto query, string? sheetName, string? fileName);
}
