...
public class TaktIpqcOrderItemService : TaktServiceBase, ITaktIpqcOrderItemService
{
    ...
    {
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.IpqcOrderId, dto.IpqcOrderId, null, $"制程检验单明细表编码 {dto.IpqcOrderId} 已存在");
    ...
    public async Task<TaktIpqcOrderItemDto> UpdateIpqcOrderItemAsync(long id, TaktIpqcOrderItemUpdateDto dto)
    {
        ...
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.IpqcOrderId, dto.IpqcOrderId, id, $"制程检验单明细表编码 {dto.IpqcOrderId} 已存在");
