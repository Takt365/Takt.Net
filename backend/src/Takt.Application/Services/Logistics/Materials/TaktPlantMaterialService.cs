...
public class TaktPlantMaterialService : TaktServiceBase, ITaktPlantMaterialService
{
    ...
    {
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.MaterialCode, dto.MaterialCode, null, $"工厂物料表编码 {dto.MaterialCode} 已存在");
    ...
    public async Task<TaktPlantMaterialDto> UpdatePlantMaterialAsync(long id, TaktPlantMaterialUpdateDto dto)
    {
        ...
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.MaterialCode, dto.MaterialCode, id, $"工厂物料表编码 {dto.MaterialCode} 已存在");
