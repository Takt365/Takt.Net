...
public class TaktPurchaseRequestChangeLogService : TaktServiceBase, ITaktPurchaseRequestChangeLogService
{
    ...
    {
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.RequestCode, dto.RequestCode, null, $"采购申请变更记录表编码 {dto.RequestCode} 已存在");
    ...
    public async Task<TaktPurchaseRequestChangeLogDto> UpdatePurchaseRequestChangeLogAsync(long id, TaktPurchaseRequestChangeLogUpdateDto dto)
    {
        ...
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.RequestCode, dto.RequestCode, id, $"采购申请变更记录表编码 {dto.RequestCode} 已存在");
