...
public class TaktProductionOrderService : TaktServiceBase, ITaktProductionOrderService
{
    ...
    {
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.ProdOrderCode, dto.ProdOrderCode, null, $"生产工单表编码 {dto.ProdOrderCode} 已存在");
    ...
    public async Task<TaktProductionOrderDto> UpdateProductionOrderAsync(long id, TaktProductionOrderUpdateDto dto)
    {
        ...
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.ProdOrderCode, dto.ProdOrderCode, id, $"生产工单表编码 {dto.ProdOrderCode} 已存在");
