...
public class TaktPersonnelOperationRateService : TaktServiceBase, ITaktPersonnelOperationRateService
{
    ...
    {
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.PlantCode, dto.PlantCode, null, $"人员稼动率表编码 {dto.PlantCode} 已存在");
    ...
    public async Task<TaktPersonnelOperationRateDto> UpdatePersonnelOperationRateAsync(long id, TaktPersonnelOperationRateUpdateDto dto)
    {
        ...
        await TaktUniqueValidatorExtensions.ValidateUniqueAsync(_repository, x => x.PlantCode, dto.PlantCode, id, $"人员稼动率表编码 {dto.PlantCode} 已存在");
