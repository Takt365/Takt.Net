...
public partial class TaktGenTableDto : TaktDtosEntityBase
{
    ...
    public long GenTableId { get; set; } = 0;
    ...
    /// <summary>
    /// 字段配置列表（子表，外键：TaktGenTableColumn.GenTableId 关联本表 Id）（外键在子表 TaktGenTableColumnDto.GenTableId）
    /// </summary>
...
public partial class TaktGenTableCreateDto
{
    ...
    /// <summary>
    /// 字段配置列表（子表，外键：TaktGenTableColumn.GenTableId 关联本表 Id）（外键在子表 TaktGenTableColumnCreateDto.GenTableId）
    /// </summary>
