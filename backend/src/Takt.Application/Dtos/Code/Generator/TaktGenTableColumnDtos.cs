...
// 功能描述：Takt代码生成字段配置DTO，与 TaktGenTableColumn 实体同步；列级 IsQuery/IsCreate/IsExport 等为字段控制，与表 GenFunction 无关
// 
...
/// Takt代码生成字段配置DTO
/// </summary>
public class TaktGenTableColumnDto
{
    /// <summary>
    /// 构造函数
    /// </summary>
    ...
    /// <summary>
    /// 【字段控制】是否为新增字段（0=是，1=否），指该列是否参与新增表单，与表 GenFunction 无关。
    /// </summary>
    public int IsCreate { get; set; }

    /// <summary>
    /// 【字段控制】是否更新字段（0=是，1=否），指该列是否参与更新表单，与表 GenFunction 无关。
    /// </summary>
    ...
    /// <summary>
    /// 【字段控制】是否导出字段（0=是，1=否），指该列是否参与导出，与表 GenFunction 无关。
    /// </summary>
    ...
    /// <summary>
    /// 【字段控制】是否查询字段（0=是，1=否），指该列是否作为查询条件，与表 GenFunction 无关。
    /// </summary>
...
/// <summary>
/// Takt代码生成字段配置导入模板DTO（仅针对此表本身的模板下载）
/// </summary>
...
/// <summary>
/// Takt代码生成字段配置导入DTO（仅针对此表本身的Excel导入）
/// </summary>
...
/// <summary>
/// Takt代码生成字段配置导出DTO（仅针对此表本身的Excel导出）
/// </summary>
