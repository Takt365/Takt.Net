...
public partial class TaktPostDto : TaktDtosEntityBase
{
    ...
    /// <summary>
    /// 岗位代理规则列表（外键在子表 ）（外键在子表 TaktPostDelegateDto.PostId）
    /// </summary>
    public List<TaktPostDelegateDto>? PostDelegates { get; set; }
}
...
public partial class TaktPostCreateDto
{
    ...
    /// <summary>
    /// 岗位代理规则列表（外键在子表 ）（外键在子表 TaktPostDelegateCreateDto.PostId）
    /// </summary>
    public List<TaktPostDelegateCreateDto>? PostDelegates { get; set; }
...
/// 岗位信息表排序DTO
/// </summary>
public partial class TaktPostSortDto
{
    /// <summary>
    /// 构造函数
    /// </summary>
    public TaktPostSortDto()
    {
    }
