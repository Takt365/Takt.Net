...
public partial class TaktDeptDto : TaktDtosEntityBase
{
    ...
    /// <summary>
    /// 部门代理人列表（外键在子表 ）（外键在子表 TaktDeptDelegateDto.DeptId）
    /// </summary>
    public List<TaktDeptDelegateDto>? DeptDelegates { get; set; }
}
...
public partial class TaktDeptCreateDto
{
    ...
    /// <summary>
    /// 部门代理人列表（外键在子表 ）（外键在子表 TaktDeptDelegateCreateDto.DeptId）
    /// </summary>
    public List<TaktDeptDelegateCreateDto>? DeptDelegates { get; set; }
...
/// 部门信息表排序DTO
/// </summary>
public partial class TaktDeptSortDto
{
    /// <summary>
    /// 构造函数
    /// </summary>
    public TaktDeptSortDto()
    {
    }
