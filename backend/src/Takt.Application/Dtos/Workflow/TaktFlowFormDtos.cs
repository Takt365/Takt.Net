...
public partial class TaktFlowFormDto : TaktDtosEntityBase
{
    ...
    public long FlowFormId { get; set; } = 0;
...
/// 流程表单表表单状态DTO
/// </summary>
public partial class TaktFlowFormFormStatusDto
{
    /// <summary>
    /// 构造函数
    /// </summary>
    public TaktFlowFormFormStatusDto()
    {
    }
...
/// 流程表单表排序DTO
/// </summary>
public partial class TaktFlowFormSortDto
{
    /// <summary>
    /// 构造函数
    /// </summary>
    public TaktFlowFormSortDto()
    {
    }
