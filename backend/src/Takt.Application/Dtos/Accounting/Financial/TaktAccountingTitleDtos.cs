...
public partial class TaktAccountingTitleDto : TaktDtosEntityBase
{
    ...
    public long AccountingTitleId { get; set; } = 0;
...
/// 会计科目表科目状态DTO
/// </summary>
public partial class TaktAccountingTitleTitleStatusDto
{
    /// <summary>
    /// 构造函数
    /// </summary>
    public TaktAccountingTitleTitleStatusDto()
    {
    }
...
/// 会计科目表排序DTO
/// </summary>
public partial class TaktAccountingTitleSortDto
{
    /// <summary>
    /// 构造函数
    /// </summary>
    public TaktAccountingTitleSortDto()
    {
    }
