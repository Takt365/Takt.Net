...
public partial class TaktDictTypeDto : TaktDtosEntityBase
{
    ...
    /// <summary>
    /// 字典数据列表（外键：子表 TaktDictData.DictTypeId 关联本表 Id）（外键在子表 TaktDictDataDto.DictTypeId）
    /// </summary>
...
public partial class TaktDictTypeCreateDto
{
    ...
    /// <summary>
    /// 字典数据列表（外键：子表 TaktDictData.DictTypeId 关联本表 Id）（外键在子表 TaktDictDataCreateDto.DictTypeId）
    /// </summary>
...
/// 字典类型表排序DTO
/// </summary>
public partial class TaktDictTypeSortDto
{
    /// <summary>
    /// 构造函数
    /// </summary>
    public TaktDictTypeSortDto()
    {
    }
