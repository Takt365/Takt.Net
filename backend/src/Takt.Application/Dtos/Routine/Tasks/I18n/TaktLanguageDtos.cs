...
public partial class TaktLanguageDto : TaktDtosEntityBase
{
    ...
    /// <summary>
    /// 翻译列表（主子表关系，一个语言可以有多个翻译）（外键在子表 TaktTranslationDto.LanguageId）
    /// </summary>
    public List<TaktTranslationDto>? Translations { get; set; }
}
...
public partial class TaktLanguageCreateDto
{
    ...
    /// <summary>
    /// 翻译列表（主子表关系，一个语言可以有多个翻译）（外键在子表 TaktTranslationCreateDto.LanguageId）
    /// </summary>
    public List<TaktTranslationCreateDto>? Translations { get; set; }
...
/// 语言表排序DTO
/// </summary>
public partial class TaktLanguageSortDto
{
    /// <summary>
    /// 构造函数
    /// </summary>
    public TaktLanguageSortDto()
    {
    }
