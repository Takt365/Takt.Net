...
/// <summary>
/// 翻译转置DTO（用于翻译列表的转置展示，按资源键分组，各语言为列）
/// </summary>
public partial class TaktTranslationTransposedDto
{
    /// <summary>
...
/// <summary>
/// 翻译转置结果DTO（包含分页数据和语言列顺序）
/// </summary>
public partial class TaktTranslationTransposedResultDto
{
    /// <summary>
    /// 分页数据
    /// </summary>
    ...
    /// <summary>
    /// 语言列顺序（表头从左到右），如 zh-CN、zh-TW、zh-HK、en-US、ja-JP、ko-KR 等
    /// </summary>
