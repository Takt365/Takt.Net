...
public partial class TaktKnowledgeDto : TaktDtosEntityBase
{
    ...
    public long KnowledgeId { get; set; } = 0;
    ...
    /// <summary>
    /// 知识库变更日志列表（主子表关系）（外键在子表 TaktKnowledgeChangeLogDto.KnowledgeId）
    /// </summary>
...
public partial class TaktKnowledgeCreateDto
{
    ...
    /// <summary>
    /// 知识库变更日志列表（主子表关系）（外键在子表 TaktKnowledgeChangeLogCreateDto.KnowledgeId）
    /// </summary>
...
/// 知识库表排序DTO
/// </summary>
public partial class TaktKnowledgeSortDto
{
    /// <summary>
    /// 构造函数
    /// </summary>
    public TaktKnowledgeSortDto()
    {
    }
