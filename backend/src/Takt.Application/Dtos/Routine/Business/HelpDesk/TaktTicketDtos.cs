...
public partial class TaktTicketDto : TaktDtosEntityBase
{
    ...
    /// <summary>
    /// 子工单列表（父工单时有效；外键：本表 Id = 子工单 ParentTicketId）（外键在子表 TaktTicketDto.Id）
    /// </summary>
    ...
    /// 服务评价（工单关闭后的评价，一对一）
    /// </summary>
    public TaktTicketEvaluationDto? Evaluation { get; set; }

    /// <summary>
    /// 工单变更日志列表（主子表关系）（外键在子表 TaktTicketChangeLogDto.TicketId）
    /// </summary>
...
public partial class TaktTicketCreateDto
{
    ...
    /// <summary>
    /// 子工单列表（父工单时有效；外键：本表 Id = 子工单 ParentTicketId）（外键在子表 TaktTicketCreateDto.Id）
    /// </summary>
    public List<TaktTicketCreateDto>? ChildTickets { get; set; }


    /// <summary>
    /// 工单变更日志列表（主子表关系）（外键在子表 TaktTicketChangeLogCreateDto.TicketId）
    /// </summary>
