...
public partial class TaktNewsCommentDto : TaktDtosEntityBase
{
    ...
    public long NewsCommentId { get; set; } = 0;
    ...
    /// <summary>
    /// 评论点赞记录列表（主子表关系）（外键在子表 TaktNewsCommentLikeDto.CommentId）
    /// </summary>
...
public partial class TaktNewsCommentCreateDto
{
    ...
    /// <summary>
    /// 评论点赞记录列表（主子表关系）（外键在子表 TaktNewsCommentLikeCreateDto.CommentId）
    /// </summary>
...
/// 新闻评论表评论状态DTO
/// </summary>
public partial class TaktNewsCommentCommentStatusDto
{
    /// <summary>
    /// 构造函数
    /// </summary>
    public TaktNewsCommentCommentStatusDto()
    {
    }
