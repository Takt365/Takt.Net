...
public partial class TaktNewsDto : TaktDtosEntityBase
{
    ...
    /// <summary>
    /// 新闻附件列表（主子表关系）（外键在子表 TaktNewsAttachmentDto.NewsId）
    /// </summary>
    public List<TaktNewsAttachmentDto>? Attachments { get; set; }

    /// <summary>
    /// 新闻评论列表（主子表关系）（外键在子表 TaktNewsCommentDto.NewsId）
    /// </summary>
    public List<TaktNewsCommentDto>? Comments { get; set; }

    /// <summary>
    /// 新闻点赞记录列表（主子表关系）（外键在子表 TaktNewsLikeDto.NewsId）
    /// </summary>
    public List<TaktNewsLikeDto>? Likes { get; set; }

    /// <summary>
    /// 新闻阅读记录列表（主子表关系）（外键在子表 TaktNewsReadDto.NewsId）
    /// </summary>
    public List<TaktNewsReadDto>? Reads { get; set; }

    /// <summary>
    /// 新闻收藏记录列表（主子表关系）（外键在子表 TaktNewsFavoriteDto.NewsId）
    /// </summary>
    public List<TaktNewsFavoriteDto>? Favorites { get; set; }

    /// <summary>
    /// 新闻分享记录列表（主子表关系）（外键在子表 TaktNewsShareDto.NewsId）
    /// </summary>
...
public partial class TaktNewsCreateDto
{
    ...
    /// <summary>
    /// 新闻附件列表（主子表关系）（外键在子表 TaktNewsAttachmentCreateDto.NewsId）
    /// </summary>
    public List<TaktNewsAttachmentCreateDto>? Attachments { get; set; }


    /// <summary>
    /// 新闻评论列表（主子表关系）（外键在子表 TaktNewsCommentCreateDto.NewsId）
    /// </summary>
    public List<TaktNewsCommentCreateDto>? Comments { get; set; }


    /// <summary>
    /// 新闻点赞记录列表（主子表关系）（外键在子表 TaktNewsLikeCreateDto.NewsId）
    /// </summary>
    public List<TaktNewsLikeCreateDto>? Likes { get; set; }


    /// <summary>
    /// 新闻阅读记录列表（主子表关系）（外键在子表 TaktNewsReadCreateDto.NewsId）
    /// </summary>
    public List<TaktNewsReadCreateDto>? Reads { get; set; }


    /// <summary>
    /// 新闻收藏记录列表（主子表关系）（外键在子表 TaktNewsFavoriteCreateDto.NewsId）
    /// </summary>
    public List<TaktNewsFavoriteCreateDto>? Favorites { get; set; }


    /// <summary>
    /// 新闻分享记录列表（主子表关系）（外键在子表 TaktNewsShareCreateDto.NewsId）
    /// </summary>
...
/// 新闻表排序DTO
/// </summary>
public partial class TaktNewsSortDto
{
    /// <summary>
    /// 构造函数
    /// </summary>
    public TaktNewsSortDto()
    {
    }
