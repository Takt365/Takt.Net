...
public partial class TaktMailDto : TaktDtosEntityBase
{
    ...
    /// <summary>
    /// 邮件附件列表（主子表关系）（外键在子表 TaktMailAttachmentDto.MailId）
    /// </summary>
    public List<TaktMailAttachmentDto>? Attachments { get; set; }

    /// <summary>
    /// 邮件收件人列表（主子表关系）（外键在子表 TaktMailRecipientDto.MailId）
    /// </summary>
    public List<TaktMailRecipientDto>? Recipients { get; set; }
}
...
public partial class TaktMailCreateDto
{
    ...
    /// <summary>
    /// 邮件附件列表（主子表关系）（外键在子表 TaktMailAttachmentCreateDto.MailId）
    /// </summary>
    public List<TaktMailAttachmentCreateDto>? Attachments { get; set; }


    /// <summary>
    /// 邮件收件人列表（主子表关系）（外键在子表 TaktMailRecipientCreateDto.MailId）
    /// </summary>
    public List<TaktMailRecipientCreateDto>? Recipients { get; set; }
