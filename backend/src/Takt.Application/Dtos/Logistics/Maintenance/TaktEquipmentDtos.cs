...
public partial class TaktEquipmentDto : TaktDtosEntityBase
{
    ...
    /// <summary>
    /// 维护记录列表（外键：子表 TaktMaintenance.EquipmentId 关联本表 Id）（外键在子表 TaktMaintenanceDto.EquipmentId）
    /// </summary>
...
public partial class TaktEquipmentCreateDto
{
    ...
    /// <summary>
    /// 维护记录列表（外键：子表 TaktMaintenance.EquipmentId 关联本表 Id）（外键在子表 TaktMaintenanceCreateDto.EquipmentId）
    /// </summary>
