...
public partial class TaktEcDto : TaktDtosEntityBase
{
    ...
    public TaktEcDto()
    {
        ...
        EcnNo = string.Empty;
        EcnTitle = string.Empty;
        EcnDetailText = string.Empty;
        EcnLeader = string.Empty;
        EcnDistinction = string.Empty;
    }
    ...
    /// <summary>
    /// 设变明细列表（外键在子表 TaktEcDetailDto.EcnId）
    /// </summary>
    public List<TaktEcDetailDto>? EcnDetails { get; set; }

    /// <summary>
    /// 设变附件列表（一个设变可对应多个附件）（外键在子表 TaktEcAttachmentDto.EcnId）
    /// </summary>
...
public partial class TaktEcCreateDto
{
    ...
    /// <summary>
    /// 设变明细列表（外键在子表 TaktEcDetailCreateDto.EcnId）
    /// </summary>
    public List<TaktEcDetailCreateDto>? EcnDetails { get; set; }


    /// <summary>
    /// 设变附件列表（一个设变可对应多个附件）（外键在子表 TaktEcAttachmentCreateDto.EcnId）
    /// </summary>
...
/// 设变主表变更状态DTO
/// </summary>
public partial class TaktEcChangeStatusDto
{
    /// <summary>
    /// 构造函数
    /// </summary>
    public TaktEcChangeStatusDto()
    {
    }
