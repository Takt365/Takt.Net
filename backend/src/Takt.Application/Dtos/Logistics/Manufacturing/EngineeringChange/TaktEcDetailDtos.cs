...
public partial class TaktEcDetailDto : TaktDtosEntityBase
{
    ...
    /// 构造函数
    /// </summary>
    public TaktEcDetailDto()
    {
        EcnNo = string.Empty;
        EcnModel = string.Empty;
    }
    ...
    public long EcDetailId { get; set; } = 0;
    ...
    /// <summary>
    /// 设变明细-部门记录列表（按 DeptCode 区分部门：Assy/It/Cus/Fins/Gas/Iqc/Mc/Mp/Pcba/Pmc/Qa/Te/Eng）（外键在子表 TaktEcDeptDto.EcnDetailId）
    /// </summary>
...
public partial class TaktEcDetailCreateDto
{
    ...
    /// <summary>
    /// 设变明细-部门记录列表（按 DeptCode 区分部门：Assy/It/Cus/Fins/Gas/Iqc/Mc/Mp/Pcba/Pmc/Qa/Te/Eng）（外键在子表 TaktEcDeptCreateDto.EcnDetailId）
    /// </summary>
...
public partial class TaktEcDetailTemplateDto
{
    ...
    /// 构造函数
    /// </summary>
    public TaktEcDetailTemplateDto()
    {
        EcnNo = string.Empty;
        EcnModel = string.Empty;
    }
