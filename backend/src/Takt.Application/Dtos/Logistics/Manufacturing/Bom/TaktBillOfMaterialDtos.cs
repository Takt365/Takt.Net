...
public partial class TaktBillOfMaterialDto : TaktDtosEntityBase
{
    ...
    public long BillOfMaterialId { get; set; } = 0;
    ...
    /// <summary>
    /// BOM明细列表（主子表关系，一个BOM可以有多个明细）（外键在子表 TaktBillOfMaterialItemDto.BillOfMaterialId）
    /// </summary>
    public List<TaktBillOfMaterialItemDto>? Items { get; set; }

    /// <summary>
    /// BOM变更记录列表（外键在子表 ）（外键在子表 TaktBillOfMaterialChangeLogDto.BillOfMaterialId）
    /// </summary>
...
public partial class TaktBillOfMaterialCreateDto
{
    ...
    /// <summary>
    /// BOM明细列表（主子表关系，一个BOM可以有多个明细）（外键在子表 TaktBillOfMaterialItemCreateDto.BillOfMaterialId）
    /// </summary>
    public List<TaktBillOfMaterialItemCreateDto>? Items { get; set; }


    /// <summary>
    /// BOM变更记录列表（外键在子表 ）（外键在子表 TaktBillOfMaterialChangeLogCreateDto.BillOfMaterialId）
    /// </summary>
...
/// 物料清单表排序DTO
/// </summary>
public partial class TaktBillOfMaterialSortDto
{
    /// <summary>
    /// 构造函数
    /// </summary>
    public TaktBillOfMaterialSortDto()
    {
    }
