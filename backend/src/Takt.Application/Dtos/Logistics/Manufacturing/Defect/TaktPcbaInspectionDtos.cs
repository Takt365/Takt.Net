...
public partial class TaktPcbaInspectionDto : TaktDtosEntityBase
{
    ...
    public long PcbaInspectionId { get; set; } = 0;
    ...
    /// <summary>
    /// PCBA检查明细列表（外键在子表 TaktPcbaInspectionDetailDto.PcbaInspectionId）
    /// </summary>
...
public partial class TaktPcbaInspectionCreateDto
{
    ...
    /// <summary>
    /// PCBA检查明细列表（外键在子表 TaktPcbaInspectionDetailCreateDto.PcbaInspectionId）
    /// </summary>
