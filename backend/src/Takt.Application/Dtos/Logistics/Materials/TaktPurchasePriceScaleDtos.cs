...
public partial class TaktPurchasePriceScaleDto : TaktDtosEntityBase
{
    ...
    public long PurchasePriceScaleId { get; set; } = 0;
...
/// 采购价格阶梯表排序DTO
/// </summary>
public partial class TaktPurchasePriceScaleSortDto
{
    /// <summary>
    /// 构造函数
    /// </summary>
    public TaktPurchasePriceScaleSortDto()
    {
    }
...
public partial class TaktPurchasePriceScaleTemplateDto
{
    ...
    /// 构造函数
    /// </summary>
    public TaktPurchasePriceScaleTemplateDto()
    {
        PurchasePriceCode = string.Empty;
    }
...
public partial class TaktPurchasePriceScaleImportDto
{
    ...
    /// 构造函数
    /// </summary>
    public TaktPurchasePriceScaleImportDto()
    {
        PurchasePriceCode = string.Empty;
    }
