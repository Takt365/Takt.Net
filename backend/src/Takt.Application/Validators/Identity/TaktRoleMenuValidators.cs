...
public class TaktRoleMenuCreateDtoValidator : AbstractValidator<TaktRoleMenuCreateDto>
{
    ...
    public TaktRoleMenuCreateDtoValidator(ITaktValidationMessages validationMessages)
    {
...
/// </summary>
/// <remarks>
/// 继承 <see cref="TaktRoleMenuCreateDtoValidator"/> 的所有验证规则，并额外验证：
/// <list type="bullet">
///   <item>RoleMenuId 必须大于 0</item>
/// </list>
/// </remarks>
public class TaktRoleMenuUpdateDtoValidator : AbstractValidator<TaktRoleMenuUpdateDto>
{
    ...
    /// </summary>
    /// <param name="validationMessages">验证消息格式化器</param>
    public TaktRoleMenuUpdateDtoValidator(ITaktValidationMessages validationMessages)
    {
        _validationMessages = validationMessages;
        Include(new TaktRoleMenuCreateDtoValidator(validationMessages));

        RuleFor(x => x.RoleMenuId)
            .GreaterThan(0)
            .WithMessage(_validationMessages.Required("entity.rolemenu.rolemenuid"));
