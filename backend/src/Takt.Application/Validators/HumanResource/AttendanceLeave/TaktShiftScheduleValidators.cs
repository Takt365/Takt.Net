...
public class TaktShiftScheduleCreateDtoValidator : AbstractValidator<TaktShiftScheduleCreateDto>
{
    ...
    public TaktShiftScheduleCreateDtoValidator(ITaktValidationMessages validationMessages)
    {
        _validationMessages = validationMessages;
        RuleFor(x => x.ScheduleType)
            .InclusiveBetween(0, 1)
            .WithMessage(_validationMessages.FormatInvalid("entity.shiftschedule.scheduletype"));
    }
}
...
/// </summary>
/// <remarks>
/// 继承 <see cref="TaktShiftScheduleCreateDtoValidator"/> 的所有验证规则，并额外验证：
/// <list type="bullet">
///   <item>ShiftScheduleId 必须大于 0</item>
/// </list>
/// </remarks>
public class TaktShiftScheduleUpdateDtoValidator : AbstractValidator<TaktShiftScheduleUpdateDto>
{
    ...
    /// </summary>
    /// <param name="validationMessages">验证消息格式化器</param>
    public TaktShiftScheduleUpdateDtoValidator(ITaktValidationMessages validationMessages)
    {
        _validationMessages = validationMessages;
        Include(new TaktShiftScheduleCreateDtoValidator(validationMessages));

        RuleFor(x => x.ShiftScheduleId)
            .GreaterThan(0)
            .WithMessage(_validationMessages.Required("entity.shiftschedule.shiftscheduleid"));
