...
public class TaktDeptDelegateCreateDtoValidator : AbstractValidator<TaktDeptDelegateCreateDto>
{
    ...
    public TaktDeptDelegateCreateDtoValidator(ITaktValidationMessages validationMessages)
    {
...
/// </summary>
/// <remarks>
/// 继承 <see cref="TaktDeptDelegateCreateDtoValidator"/> 的所有验证规则，并额外验证：
/// <list type="bullet">
///   <item>DeptDelegateId 必须大于 0</item>
/// </list>
/// </remarks>
public class TaktDeptDelegateUpdateDtoValidator : AbstractValidator<TaktDeptDelegateUpdateDto>
{
    ...
    /// </summary>
    /// <param name="validationMessages">验证消息格式化器</param>
    public TaktDeptDelegateUpdateDtoValidator(ITaktValidationMessages validationMessages)
    {
        _validationMessages = validationMessages;
        Include(new TaktDeptDelegateCreateDtoValidator(validationMessages));

        RuleFor(x => x.DeptDelegateId)
            .GreaterThan(0)
            .WithMessage(_validationMessages.Required("entity.deptdelegate.deptdelegateid"));
