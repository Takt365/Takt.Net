...
public class TaktUserPostCreateDtoValidator : AbstractValidator<TaktUserPostCreateDto>
{
    ...
    public TaktUserPostCreateDtoValidator(ITaktValidationMessages validationMessages)
    {
...
/// </summary>
/// <remarks>
/// 继承 <see cref="TaktUserPostCreateDtoValidator"/> 的所有验证规则，并额外验证：
/// <list type="bullet">
///   <item>UserPostId 必须大于 0</item>
/// </list>
/// </remarks>
public class TaktUserPostUpdateDtoValidator : AbstractValidator<TaktUserPostUpdateDto>
{
    ...
    /// </summary>
    /// <param name="validationMessages">验证消息格式化器</param>
    public TaktUserPostUpdateDtoValidator(ITaktValidationMessages validationMessages)
    {
        _validationMessages = validationMessages;
        Include(new TaktUserPostCreateDtoValidator(validationMessages));

        RuleFor(x => x.UserPostId)
            .GreaterThan(0)
            .WithMessage(_validationMessages.Required("entity.userpost.userpostid"));
