...
public class TaktEmployeeDeptCreateDtoValidator : AbstractValidator<TaktEmployeeDeptCreateDto>
{
    ...
    public TaktEmployeeDeptCreateDtoValidator(ITaktValidationMessages validationMessages)
    {
...
/// </summary>
/// <remarks>
/// 继承 <see cref="TaktEmployeeDeptCreateDtoValidator"/> 的所有验证规则，并额外验证：
/// <list type="bullet">
///   <item>EmployeeDeptId 必须大于 0</item>
/// </list>
/// </remarks>
public class TaktEmployeeDeptUpdateDtoValidator : AbstractValidator<TaktEmployeeDeptUpdateDto>
{
    ...
    /// </summary>
    /// <param name="validationMessages">验证消息格式化器</param>
    public TaktEmployeeDeptUpdateDtoValidator(ITaktValidationMessages validationMessages)
    {
        _validationMessages = validationMessages;
        Include(new TaktEmployeeDeptCreateDtoValidator(validationMessages));

        RuleFor(x => x.EmployeeDeptId)
            .GreaterThan(0)
            .WithMessage(_validationMessages.Required("entity.employeedept.employeedeptid"));
