...
public class TaktEmployeeDelegateCreateDtoValidator : AbstractValidator<TaktEmployeeDelegateCreateDto>
{
    ...
    public TaktEmployeeDelegateCreateDtoValidator(ITaktValidationMessages validationMessages)
    {
...
/// </summary>
/// <remarks>
/// 继承 <see cref="TaktEmployeeDelegateCreateDtoValidator"/> 的所有验证规则，并额外验证：
/// <list type="bullet">
///   <item>EmployeeDelegateId 必须大于 0</item>
/// </list>
/// </remarks>
public class TaktEmployeeDelegateUpdateDtoValidator : AbstractValidator<TaktEmployeeDelegateUpdateDto>
{
    ...
    /// </summary>
    /// <param name="validationMessages">验证消息格式化器</param>
    public TaktEmployeeDelegateUpdateDtoValidator(ITaktValidationMessages validationMessages)
    {
        _validationMessages = validationMessages;
        Include(new TaktEmployeeDelegateCreateDtoValidator(validationMessages));

        RuleFor(x => x.EmployeeDelegateId)
            .GreaterThan(0)
            .WithMessage(_validationMessages.Required("entity.employeedelegate.employeedelegateid"));
