...
public class TaktQualityOperationOtherCreateDtoValidator : AbstractValidator<TaktQualityOperationOtherCreateDto>
{
    ...
    public TaktQualityOperationOtherCreateDtoValidator(ITaktValidationMessages validationMessages)
    {
...
/// </summary>
/// <remarks>
/// 继承 <see cref="TaktQualityOperationOtherCreateDtoValidator"/> 的所有验证规则，并额外验证：
/// <list type="bullet">
///   <item>QualityOperationOtherId 必须大于 0</item>
/// </list>
/// </remarks>
public class TaktQualityOperationOtherUpdateDtoValidator : AbstractValidator<TaktQualityOperationOtherUpdateDto>
{
    ...
    /// </summary>
    /// <param name="validationMessages">验证消息格式化器</param>
    public TaktQualityOperationOtherUpdateDtoValidator(ITaktValidationMessages validationMessages)
    {
        _validationMessages = validationMessages;
        Include(new TaktQualityOperationOtherCreateDtoValidator(validationMessages));

        RuleFor(x => x.QualityOperationOtherId)
            .GreaterThan(0)
            .WithMessage(_validationMessages.Required("entity.qualityoperationother.qualityoperationotherid"));
