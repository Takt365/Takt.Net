...
public class TaktQualityOperationFirstArticleCreateDtoValidator : AbstractValidator<TaktQualityOperationFirstArticleCreateDto>
{
    ...
    public TaktQualityOperationFirstArticleCreateDtoValidator(ITaktValidationMessages validationMessages)
    {
...
/// </summary>
/// <remarks>
/// 继承 <see cref="TaktQualityOperationFirstArticleCreateDtoValidator"/> 的所有验证规则，并额外验证：
/// <list type="bullet">
///   <item>QualityOperationFirstArticleId 必须大于 0</item>
/// </list>
/// </remarks>
public class TaktQualityOperationFirstArticleUpdateDtoValidator : AbstractValidator<TaktQualityOperationFirstArticleUpdateDto>
{
    ...
    /// </summary>
    /// <param name="validationMessages">验证消息格式化器</param>
    public TaktQualityOperationFirstArticleUpdateDtoValidator(ITaktValidationMessages validationMessages)
    {
        _validationMessages = validationMessages;
        Include(new TaktQualityOperationFirstArticleCreateDtoValidator(validationMessages));

        RuleFor(x => x.QualityOperationFirstArticleId)
            .GreaterThan(0)
            .WithMessage(_validationMessages.Required("entity.qualityoperationfirstarticle.qualityoperationfirstarticleid"));
