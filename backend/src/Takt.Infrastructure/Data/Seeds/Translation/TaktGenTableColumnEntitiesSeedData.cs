...
public class TaktGenTableColumnEntitiesSeedData : ITaktSeedData
{
    ...
    private static List<TaktTranslation> GetAllGenTableColumnEntityTranslations()
    {
        return new List<TaktTranslation>
        {
            ...
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.gentablecolumn.length", TranslationValue = "长度", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.gentablecolumn.length", TranslationValue = "長度", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            ...
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.gentablecolumn.decimaldigits", TranslationValue = "精度", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.gentablecolumn.decimaldigits", TranslationValue = "精度", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            ...
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.gentablecolumn.ispk", TranslationValue = "主键", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.gentablecolumn.ispk", TranslationValue = "主鍵", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            ...
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.gentablecolumn.isincrement", TranslationValue = "自增", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.gentablecolumn.isincrement", TranslationValue = "自增", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            ...
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.gentablecolumn.isrequired", TranslationValue = "必填", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.gentablecolumn.isrequired", TranslationValue = "必填", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },

            // entity.gentablecolumn.iscreate
            new TaktTranslation { CultureCode = "ar-SA", ResourceKey = "entity.gentablecolumn.iscreate", TranslationValue = "إدراج", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "en-US", ResourceKey = "entity.gentablecolumn.iscreate", TranslationValue = "Create", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "es-ES", ResourceKey = "entity.gentablecolumn.iscreate", TranslationValue = "Crear", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "fr-FR", ResourceKey = "entity.gentablecolumn.iscreate", TranslationValue = "Créer", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ja-JP", ResourceKey = "entity.gentablecolumn.iscreate", TranslationValue = "新增", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ko-KR", ResourceKey = "entity.gentablecolumn.iscreate", TranslationValue = "추가", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ru-RU", ResourceKey = "entity.gentablecolumn.iscreate", TranslationValue = "Вставка", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.gentablecolumn.iscreate", TranslationValue = "新增", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.gentablecolumn.iscreate", TranslationValue = "新增", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },

            // entity.gentablecolumn.isupdate
            new TaktTranslation { CultureCode = "ar-SA", ResourceKey = "entity.gentablecolumn.isupdate", TranslationValue = "تحديث", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "en-US", ResourceKey = "entity.gentablecolumn.isupdate", TranslationValue = "Update", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "es-ES", ResourceKey = "entity.gentablecolumn.isupdate", TranslationValue = "Actualizar", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "fr-FR", ResourceKey = "entity.gentablecolumn.isupdate", TranslationValue = "Mise à jour", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ja-JP", ResourceKey = "entity.gentablecolumn.isupdate", TranslationValue = "更新", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ko-KR", ResourceKey = "entity.gentablecolumn.isupdate", TranslationValue = "수정", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ru-RU", ResourceKey = "entity.gentablecolumn.isupdate", TranslationValue = "Обновление", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.gentablecolumn.isupdate", TranslationValue = "更新", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.gentablecolumn.isupdate", TranslationValue = "更新", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },

            // entity.gentablecolumn.islist
            new TaktTranslation { CultureCode = "ar-SA", ResourceKey = "entity.gentablecolumn.islist", TranslationValue = "قائمة", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "en-US", ResourceKey = "entity.gentablecolumn.islist", TranslationValue = "List", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "es-ES", ResourceKey = "entity.gentablecolumn.islist", TranslationValue = "Lista", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "fr-FR", ResourceKey = "entity.gentablecolumn.islist", TranslationValue = "Liste", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ja-JP", ResourceKey = "entity.gentablecolumn.islist", TranslationValue = "リスト", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ko-KR", ResourceKey = "entity.gentablecolumn.islist", TranslationValue = "목록", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ru-RU", ResourceKey = "entity.gentablecolumn.islist", TranslationValue = "Список", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.gentablecolumn.islist", TranslationValue = "列表", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.gentablecolumn.islist", TranslationValue = "列表", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            ...
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.gentablecolumn.isexport", TranslationValue = "导出", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.gentablecolumn.isexport", TranslationValue = "導出", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            ...
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.gentablecolumn.issort", TranslationValue = "排序", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.gentablecolumn.issort", TranslationValue = "排序", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },

            // entity.gentablecolumn.isquery
            new TaktTranslation { CultureCode = "ar-SA", ResourceKey = "entity.gentablecolumn.isquery", TranslationValue = "استعلام", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "en-US", ResourceKey = "entity.gentablecolumn.isquery", TranslationValue = "Query", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "es-ES", ResourceKey = "entity.gentablecolumn.isquery", TranslationValue = "Consulta", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "fr-FR", ResourceKey = "entity.gentablecolumn.isquery", TranslationValue = "Requête", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ja-JP", ResourceKey = "entity.gentablecolumn.isquery", TranslationValue = "検索", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ko-KR", ResourceKey = "entity.gentablecolumn.isquery", TranslationValue = "조회", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ru-RU", ResourceKey = "entity.gentablecolumn.isquery", TranslationValue = "Запрос", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.gentablecolumn.isquery", TranslationValue = "查询", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.gentablecolumn.isquery", TranslationValue = "查詢", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            ...
            new TaktTranslation { CultureCode = "ar-SA", ResourceKey = "entity.gentablecolumn.dicttype", TranslationValue = "قاموس", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "en-US", ResourceKey = "entity.gentablecolumn.dicttype", TranslationValue = "Dict", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "es-ES", ResourceKey = "entity.gentablecolumn.dicttype", TranslationValue = "Diccionario", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "fr-FR", ResourceKey = "entity.gentablecolumn.dicttype", TranslationValue = "Dictionnaire", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ja-JP", ResourceKey = "entity.gentablecolumn.dicttype", TranslationValue = "辞書", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ko-KR", ResourceKey = "entity.gentablecolumn.dicttype", TranslationValue = "딕셔너리", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ru-RU", ResourceKey = "entity.gentablecolumn.dicttype", TranslationValue = "Словарь", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.gentablecolumn.dicttype", TranslationValue = "字典", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.gentablecolumn.dicttype", TranslationValue = "字典", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            ...
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.gentablecolumn.ordernum", TranslationValue = "序号", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.gentablecolumn.ordernum", TranslationValue = "序號", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 }
        };
    }
}
