...
public class TaktGenTableEntitiesSeedData : ITaktSeedData
{
    ...
    private static List<TaktTranslation> GetAllGenTableEntityTranslations()
    {
        return new List<TaktTranslation>
        {
            ...
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.gentable.isgencode", TranslationValue = "生成", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.gentable.isgencode", TranslationValue = "生成", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
