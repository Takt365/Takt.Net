...
public class TaktDictTypeSeedData : ITaktSeedData
{
    ...
    public async Task<(int InsertCount, int UpdateCount)> SeedAsync(IServiceProvider serviceProvider, string configId)
    {
        ...
        var dictTypes = new[]
        {
            ...
            new { Code = "sys_word_category", Name = "敏感词词性类别", Remark = "敏感词分类（与 TaktVocabulary.word_category 一致）。1=政治敏感，2=暴力恐怖，3=色情低俗，4=广告营销，5=辱骂歧视", SortOrder = 99 },
            new { Code = "sys_word_filter_level", Name = "敏感词过滤等级", Remark = "敏感词过滤等级（与 TaktVocabulary.filter_level 一致）。1=低，2=中，3=高", SortOrder = 100 },
