...
public class TaktLanguageSeedData : ITaktSeedData
{
    ...
    public async Task<(int InsertCount, int UpdateCount)> SeedAsync(IServiceProvider serviceProvider, string configId)
    {
        ...
        var languages = new[]
        {
            new { LanguageName = "阿拉伯语", CultureCode = "ar-SA", NativeName = "العربية", LanguageIcon = (string?)null, IsDefault = 0, IsRtl = 1, OrderNum = 1 },
            new { LanguageName = "英语", CultureCode = "en-US", NativeName = "English", LanguageIcon = (string?)null, IsDefault = 0, IsRtl = 0, OrderNum = 2 },
            new { LanguageName = "西班牙语", CultureCode = "es-ES", NativeName = "Español", LanguageIcon = (string?)null, IsDefault = 0, IsRtl = 0, OrderNum = 3 },
            new { LanguageName = "法语", CultureCode = "fr-FR", NativeName = "Français", LanguageIcon = (string?)null, IsDefault = 0, IsRtl = 0, OrderNum = 4 },
            new { LanguageName = "日语", CultureCode = "ja-JP", NativeName = "日本語", LanguageIcon = (string?)null, IsDefault = 0, IsRtl = 0, OrderNum = 5 },
            new { LanguageName = "韩语", CultureCode = "ko-KR", NativeName = "한국어", LanguageIcon = (string?)null, IsDefault = 0, IsRtl = 0, OrderNum = 6 },
            new { LanguageName = "俄语", CultureCode = "ru-RU", NativeName = "Русский", LanguageIcon = (string?)null, IsDefault = 0, IsRtl = 0, OrderNum = 7 },
            new { LanguageName = "中文", CultureCode = "zh-CN", NativeName = "简体中文", LanguageIcon = (string?)null, IsDefault = 1, IsRtl = 0, OrderNum = 8 },
