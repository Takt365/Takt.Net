...
public class TaktMenuButtonSeedData
{
    ...
    {
        // 通用按钮（默认模块或未知前缀）
        var buttonNames = new[] { "查询", "新增", "修改", "删除", "详情", "预览", "打印", "导入", "导出", "模板", "审批", "撤销", "树", "选项", "主题", "批量" };
        var buttonPerms = new[] { "query", "create", "update", "delete", "detail", "preview", "print", "import", "export", "template", "approve", "revoke", "tree", "options", "theme", "batch" };

        // 身份认证（identity）扩展按钮
        var buttonIdNames = new[] { "查询", "新增", "修改", "删除", "详情", "预览", "打印", "导入", "导出", "模板", "审批", "撤销", "授权", "分配", "重置密码", "变更密码", "重置", "变更", "清空", "截断", "解锁", "禁用", "树", "选项", "批量" };
        var buttonIdPerms = new[] { "query", "create", "update", "delete", "detail", "preview", "print", "import", "export", "template", "approve", "revoke", "authorize", "allocate", "resetpwd", "changepwd", "reset", "change", "empty", "truncate", "unlock", "disable", "tree", "options", "batch" };

        var buttonGenNames = new[] { "查询", "新增", "修改", "删除", "生成", "预览", "下载", "同步", "导入", "导出", "模板", "字段", "表", "数据库", "初始化", "克隆", "清空", "截断", "树", "选项", "批量" };
        var buttonGenPerms = new[] { "query", "create", "update", "delete", "generate", "preview", "download", "sync", "import", "export", "template", "columns", "tables", "databases", "initialize", "clone", "empty", "truncate", "tree", "options", "batch" };
        ...
        var buttonRoutinePerms = new[]
        {
            ...
            "transpose", "tree", "options", "theme",
            "batch"
        };

        // 人力资源（humanresource）
        var buttonHrmNames = new[] { "查询", "新增", "修改", "删除", "详情", "预览", "打印", "导入", "导出", "模板", "审批", "撤销", "核算", "树", "选项", "批量" };
        var buttonHrmPerms = new[] { "query", "create", "update", "delete", "detail", "preview", "print", "import", "export", "template", "approve", "revoke", "calculate", "tree", "options", "batch" };
