...
public class TaktRoleEntitiesSeedData : ITaktSeedData
{
    ...
    private static List<TaktTranslation> GetAllRoleEntityTranslations()
    {
        return new List<TaktTranslation>
        {
            ...
            // entity.role.roleid（主键，DTO 校验）
            new TaktTranslation { CultureCode = "ar-SA", ResourceKey = "entity.role.roleid", TranslationValue = "معرف الدور", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "en-US", ResourceKey = "entity.role.roleid", TranslationValue = "Role ID", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "es-ES", ResourceKey = "entity.role.roleid", TranslationValue = "ID de rol", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "fr-FR", ResourceKey = "entity.role.roleid", TranslationValue = "ID rôle", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ja-JP", ResourceKey = "entity.role.roleid", TranslationValue = "ロールID", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ko-KR", ResourceKey = "entity.role.roleid", TranslationValue = "역할 ID", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ru-RU", ResourceKey = "entity.role.roleid", TranslationValue = "ID роли", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.role.roleid", TranslationValue = "角色ID", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.role.roleid", TranslationValue = "角色ID", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
