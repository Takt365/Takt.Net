...
public class TaktAssyDefectDetailEntitiesSeedData : ITaktSeedData
{
    ...
    private static List<TaktTranslation> GetAllTaktAssyDefectDetailEntityTranslations()
    {
        return new List<TaktTranslation>
        {
            ...
            new TaktTranslation { CultureCode = "en-US", ResourceKey = "entity.assydefectdetail._self", TranslationValue = "组立不良明细", ResourceType = "Frontend", ResourceGroup = "Entity", SortOrder = 1 },
            new TaktTranslation { CultureCode = "ja-JP", ResourceKey = "entity.assydefectdetail._self", TranslationValue = "组立不良明细", ResourceType = "Frontend", ResourceGroup = "Entity", SortOrder = 1 },
            new TaktTranslation { CultureCode = "ko-KR", ResourceKey = "entity.assydefectdetail._self", TranslationValue = "组立不良明细", ResourceType = "Frontend", ResourceGroup = "Entity", SortOrder = 1 },
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.assydefectdetail._self", TranslationValue = "组立不良明细", ResourceType = "Frontend", ResourceGroup = "Entity", SortOrder = 1 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.assydefectdetail._self", TranslationValue = "组立不良明细", ResourceType = "Frontend", ResourceGroup = "Entity", SortOrder = 1 },
            new TaktTranslation { CultureCode = "zh-HK", ResourceKey = "entity.assydefectdetail._self", TranslationValue = "组立不良明细", ResourceType = "Frontend", ResourceGroup = "Entity", SortOrder = 1 },

            // entity.assydefectdetail.assydefectid
            new TaktTranslation { CultureCode = "en-US", ResourceKey = "entity.assydefectdetail.assydefectid", TranslationValue = "ID", ResourceType = "Frontend", ResourceGroup = "Entity", SortOrder = 3 },
            new TaktTranslation { CultureCode = "ja-JP", ResourceKey = "entity.assydefectdetail.assydefectid", TranslationValue = "ID", ResourceType = "Frontend", ResourceGroup = "Entity", SortOrder = 3 },
            new TaktTranslation { CultureCode = "ko-KR", ResourceKey = "entity.assydefectdetail.assydefectid", TranslationValue = "ID", ResourceType = "Frontend", ResourceGroup = "Entity", SortOrder = 3 },
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.assydefectdetail.assydefectid", TranslationValue = "组立不良ID", ResourceType = "Frontend", ResourceGroup = "Entity", SortOrder = 3 },
