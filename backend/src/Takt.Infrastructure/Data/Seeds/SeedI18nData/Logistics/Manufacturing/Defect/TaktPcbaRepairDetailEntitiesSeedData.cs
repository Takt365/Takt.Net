...
public class TaktPcbaRepairDetailEntitiesSeedData : ITaktSeedData
{
    ...
    private static List<TaktTranslation> GetAllTaktPcbaRepairDetailEntityTranslations()
    {
        return new List<TaktTranslation>
        {
            ...
            new TaktTranslation { CultureCode = "en-US", ResourceKey = "entity.pcbarepairdetail._self", TranslationValue = "PCBA改修明细", ResourceType = "Frontend", ResourceGroup = "Entity", SortOrder = 1 },
            new TaktTranslation { CultureCode = "ja-JP", ResourceKey = "entity.pcbarepairdetail._self", TranslationValue = "PCBA改修明细", ResourceType = "Frontend", ResourceGroup = "Entity", SortOrder = 1 },
            new TaktTranslation { CultureCode = "ko-KR", ResourceKey = "entity.pcbarepairdetail._self", TranslationValue = "PCBA改修明细", ResourceType = "Frontend", ResourceGroup = "Entity", SortOrder = 1 },
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.pcbarepairdetail._self", TranslationValue = "PCBA改修明细", ResourceType = "Frontend", ResourceGroup = "Entity", SortOrder = 1 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.pcbarepairdetail._self", TranslationValue = "PCBA改修明细", ResourceType = "Frontend", ResourceGroup = "Entity", SortOrder = 1 },
            new TaktTranslation { CultureCode = "zh-HK", ResourceKey = "entity.pcbarepairdetail._self", TranslationValue = "PCBA改修明细", ResourceType = "Frontend", ResourceGroup = "Entity", SortOrder = 1 },

            // entity.pcbarepairdetail.pcbarepairid
            new TaktTranslation { CultureCode = "en-US", ResourceKey = "entity.pcbarepairdetail.pcbarepairid", TranslationValue = "ID", ResourceType = "Frontend", ResourceGroup = "Entity", SortOrder = 3 },
            new TaktTranslation { CultureCode = "ja-JP", ResourceKey = "entity.pcbarepairdetail.pcbarepairid", TranslationValue = "ID", ResourceType = "Frontend", ResourceGroup = "Entity", SortOrder = 3 },
            new TaktTranslation { CultureCode = "ko-KR", ResourceKey = "entity.pcbarepairdetail.pcbarepairid", TranslationValue = "ID", ResourceType = "Frontend", ResourceGroup = "Entity", SortOrder = 3 },
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.pcbarepairdetail.pcbarepairid", TranslationValue = "PCBA改修ID", ResourceType = "Frontend", ResourceGroup = "Entity", SortOrder = 3 },
