...
public class TaktMenuEntitiesSeedData : ITaktSeedData
{
    ...
    private static List<TaktTranslation> GetAllMenuEntityTranslations()
    {
        return new List<TaktTranslation>
        {
            ...
            new TaktTranslation { CultureCode = "en-US", ResourceKey = "entity.menu.l10nkey", TranslationValue = "L10n Key", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "es-ES", ResourceKey = "entity.menu.l10nkey", TranslationValue = "Clave L10n", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "fr-FR", ResourceKey = "entity.menu.l10nkey", TranslationValue = "Clé L10n", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ja-JP", ResourceKey = "entity.menu.l10nkey", TranslationValue = "多言語キー", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ko-KR", ResourceKey = "entity.menu.l10nkey", TranslationValue = "현지화 키", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ru-RU", ResourceKey = "entity.menu.l10nkey", TranslationValue = "Ключ локализации", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.menu.l10nkey", TranslationValue = "本地化键", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.menu.l10nkey", TranslationValue = "在地化鍵", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            ...
            // entity.menu.type
            new TaktTranslation { CultureCode = "ar-SA", ResourceKey = "entity.menu.type", TranslationValue = "النوع", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "en-US", ResourceKey = "entity.menu.type", TranslationValue = "Type", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "es-ES", ResourceKey = "entity.menu.type", TranslationValue = "Tipo", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "fr-FR", ResourceKey = "entity.menu.type", TranslationValue = "Type", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ja-JP", ResourceKey = "entity.menu.type", TranslationValue = "タイプ", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ko-KR", ResourceKey = "entity.menu.type", TranslationValue = "유형", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ru-RU", ResourceKey = "entity.menu.type", TranslationValue = "Тип", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.menu.type", TranslationValue = "类型", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.menu.type", TranslationValue = "類型", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            ...
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.menu.isvisible", TranslationValue = "可见", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.menu.isvisible", TranslationValue = "可見", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            ...
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.menu.iscache", TranslationValue = "缓存", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.menu.iscache", TranslationValue = "快取", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },

            // entity.menu.isexternal
            new TaktTranslation { CultureCode = "ar-SA", ResourceKey = "entity.menu.isexternal", TranslationValue = "خارجي", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "en-US", ResourceKey = "entity.menu.isexternal", TranslationValue = "External", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "es-ES", ResourceKey = "entity.menu.isexternal", TranslationValue = "Externo", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "fr-FR", ResourceKey = "entity.menu.isexternal", TranslationValue = "Externe", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ja-JP", ResourceKey = "entity.menu.isexternal", TranslationValue = "外部", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ko-KR", ResourceKey = "entity.menu.isexternal", TranslationValue = "외부", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ru-RU", ResourceKey = "entity.menu.isexternal", TranslationValue = "Внешняя", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.menu.isexternal", TranslationValue = "外联", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.menu.isexternal", TranslationValue = "外聯", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            ...
            // entity.menu.menuid（主键，DTO 校验）
            new TaktTranslation { CultureCode = "ar-SA", ResourceKey = "entity.menu.menuid", TranslationValue = "معرف القائمة", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "en-US", ResourceKey = "entity.menu.menuid", TranslationValue = "Menu ID", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "es-ES", ResourceKey = "entity.menu.menuid", TranslationValue = "ID de menú", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "fr-FR", ResourceKey = "entity.menu.menuid", TranslationValue = "ID menu", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ja-JP", ResourceKey = "entity.menu.menuid", TranslationValue = "メニューID", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ko-KR", ResourceKey = "entity.menu.menuid", TranslationValue = "메뉴 ID", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ru-RU", ResourceKey = "entity.menu.menuid", TranslationValue = "ID меню", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.menu.menuid", TranslationValue = "菜单ID", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.menu.menuid", TranslationValue = "選單ID", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },

            // entity.menu.status
            new TaktTranslation { CultureCode = "ar-SA", ResourceKey = "entity.menu.status", TranslationValue = "الحالة", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "en-US", ResourceKey = "entity.menu.status", TranslationValue = "Status", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "es-ES", ResourceKey = "entity.menu.status", TranslationValue = "Estado", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "fr-FR", ResourceKey = "entity.menu.status", TranslationValue = "État", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ja-JP", ResourceKey = "entity.menu.status", TranslationValue = "状態", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ko-KR", ResourceKey = "entity.menu.status", TranslationValue = "상태", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ru-RU", ResourceKey = "entity.menu.status", TranslationValue = "Статус", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.menu.status", TranslationValue = "状态", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.menu.status", TranslationValue = "狀態", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 }
        };
    }
}
