...
public class TaktTenantEntitiesSeedData : ITaktSeedData
{
    ...
    private static List<TaktTranslation> GetAllTenantEntityTranslations()
    {
        return new List<TaktTranslation>
        {
            ...
            // entity.tenant.tenantid（主键，DTO 校验）
            new TaktTranslation { CultureCode = "ar-SA", ResourceKey = "entity.tenant.tenantid", TranslationValue = "معرف المستأجر", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "en-US", ResourceKey = "entity.tenant.tenantid", TranslationValue = "Tenant ID", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "es-ES", ResourceKey = "entity.tenant.tenantid", TranslationValue = "ID de inquilino", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "fr-FR", ResourceKey = "entity.tenant.tenantid", TranslationValue = "ID locataire", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ja-JP", ResourceKey = "entity.tenant.tenantid", TranslationValue = "テナントID", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ko-KR", ResourceKey = "entity.tenant.tenantid", TranslationValue = "테넌트 ID", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ru-RU", ResourceKey = "entity.tenant.tenantid", TranslationValue = "ID арендатора", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.tenant.tenantid", TranslationValue = "租户ID", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.tenant.tenantid", TranslationValue = "租戶ID", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },

            // entity.tenant.configid（与 TaktEntityBase.ConfigId 一致，nvarchar(2)）
            new TaktTranslation { CultureCode = "ar-SA", ResourceKey = "entity.tenant.configid", TranslationValue = "معرف التكوين", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "en-US", ResourceKey = "entity.tenant.configid", TranslationValue = "Config ID", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "es-ES", ResourceKey = "entity.tenant.configid", TranslationValue = "ID de configuración", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "fr-FR", ResourceKey = "entity.tenant.configid", TranslationValue = "ID de configuration", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ja-JP", ResourceKey = "entity.tenant.configid", TranslationValue = "設定ID", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ko-KR", ResourceKey = "entity.tenant.configid", TranslationValue = "설정 ID", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ru-RU", ResourceKey = "entity.tenant.configid", TranslationValue = "ID конфигурации", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.tenant.configid", TranslationValue = "租户配置ID", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.tenant.configid", TranslationValue = "租戶設定ID", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
