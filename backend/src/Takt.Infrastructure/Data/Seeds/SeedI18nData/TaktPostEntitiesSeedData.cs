...
public class TaktPostEntitiesSeedData : ITaktSeedData
{
    ...
    private static List<TaktTranslation> GetAllPostEntityTranslations()
    {
        return new List<TaktTranslation>
        {
            ...
            // entity.post.postid（主键，DTO 校验；与 entity.post.deptid 区分）
            new TaktTranslation { CultureCode = "ar-SA", ResourceKey = "entity.post.postid", TranslationValue = "معرف المنصب", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "en-US", ResourceKey = "entity.post.postid", TranslationValue = "Post ID", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "es-ES", ResourceKey = "entity.post.postid", TranslationValue = "ID del puesto", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "fr-FR", ResourceKey = "entity.post.postid", TranslationValue = "ID du poste", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ja-JP", ResourceKey = "entity.post.postid", TranslationValue = "ポストID", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ko-KR", ResourceKey = "entity.post.postid", TranslationValue = "직위 ID", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ru-RU", ResourceKey = "entity.post.postid", TranslationValue = "ID должности", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.post.postid", TranslationValue = "岗位ID", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.post.postid", TranslationValue = "崗位ID", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
