...
public class TaktFileEntitiesSeedData : ITaktSeedData
{
    ...
    private static List<TaktTranslation> GetAllFileEntityTranslations()
    {
        return new List<TaktTranslation>
        {
            ...
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "entity.file.size", TranslationValue = "文件大小（字节）", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "entity.file.size", TranslationValue = "檔案大小（位元組）", ResourceType = "Frontend", ResourceGroup = "Entity", OrderNum = 0 },
