...
public class TaktAssetCreateDtoValidator : AbstractValidator<TaktAssetCreateDto>
{
    public TaktAssetCreateDtoValidator(ITaktLocalizer? localizer = null)
    {
        RuleFor(x => x.CompanyCode)
            .NotEmpty().WithMessage(TaktValidationMessages.Required(localizer, "entity.asset.companycode"))
            .Must(TaktRegexHelper.IsValidCompanyCode).WithMessage(TaktValidationMessages.FormatInvalid(localizer, "entity.asset.companycode"));

        RuleFor(x => x.AssetCode)
            .NotEmpty().WithMessage(TaktValidationMessages.Required(localizer, "entity.asset.assetcode"))
            .Must(TaktRegexHelper.IsValidAssetCode).WithMessage(TaktValidationMessages.FormatInvalid(localizer, "entity.asset.assetcode"));
