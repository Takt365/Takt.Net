...
public class TaktAccountingTitleCreateDtoValidator : AbstractValidator<TaktAccountingTitleCreateDto>
{
    public TaktAccountingTitleCreateDtoValidator(ITaktLocalizer? localizer = null)
    {
        RuleFor(x => x.CompanyCode)
            .NotEmpty().WithMessage(TaktValidationMessages.Required(localizer, "entity.accountingtitle.companycode"))
            .Must(TaktRegexHelper.IsValidCompanyCode).WithMessage(TaktValidationMessages.FormatInvalid(localizer, "entity.accountingtitle.companycode"));

        RuleFor(x => x.TitleCode)
            .NotEmpty().WithMessage(TaktValidationMessages.Required(localizer, "entity.accountingtitle.titlecode"))
            .Must(TaktRegexHelper.IsValidTitleCode).WithMessage(TaktValidationMessages.FormatInvalid(localizer, "entity.accountingtitle.titlecode"));
