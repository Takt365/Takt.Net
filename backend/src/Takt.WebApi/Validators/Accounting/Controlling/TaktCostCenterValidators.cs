...
public class TaktCostCenterCreateDtoValidator : AbstractValidator<TaktCostCenterCreateDto>
{
    public TaktCostCenterCreateDtoValidator(ITaktLocalizer? localizer = null)
    {
        RuleFor(x => x.CompanyCode)
            .NotEmpty().WithMessage(TaktValidationMessages.Required(localizer, "entity.costcenter.companycode"))
            .Must(TaktRegexHelper.IsValidCompanyCode).WithMessage(TaktValidationMessages.FormatInvalid(localizer, "entity.costcenter.companycode"));
        ...
        RuleFor(x => x.CostCenterCode)
            ...
            .Must(TaktRegexHelper.IsValidCostCenterCode).WithMessage(TaktValidationMessages.FormatInvalid(localizer, "entity.costcenter.costcentercode"));
