...
public class TaktProfitCenterCreateDtoValidator : AbstractValidator<TaktProfitCenterCreateDto>
{
    public TaktProfitCenterCreateDtoValidator(ITaktLocalizer? localizer = null)
    {
        RuleFor(x => x.CompanyCode)
            .NotEmpty().WithMessage(TaktValidationMessages.Required(localizer, "entity.profitcenter.companycode"))
            .Must(TaktRegexHelper.IsValidCompanyCode).WithMessage(TaktValidationMessages.FormatInvalid(localizer, "entity.profitcenter.companycode"));
        ...
        RuleFor(x => x.ProfitCenterCode)
            ...
            .Must(TaktRegexHelper.IsValidProfitCenterCode).WithMessage(TaktValidationMessages.FormatInvalid(localizer, "entity.profitcenter.profitcentercode"));
