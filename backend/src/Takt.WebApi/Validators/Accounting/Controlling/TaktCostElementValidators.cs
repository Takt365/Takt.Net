...
public class TaktCostElementCreateDtoValidator : AbstractValidator<TaktCostElementCreateDto>
{
    public TaktCostElementCreateDtoValidator(ITaktLocalizer? localizer = null)
    {
        RuleFor(x => x.CompanyCode)
            .NotEmpty().WithMessage(TaktValidationMessages.Required(localizer, "entity.costelement.companycode"))
            .Must(TaktRegexHelper.IsValidCompanyCode).WithMessage(TaktValidationMessages.FormatInvalid(localizer, "entity.costelement.companycode"));
        ...
        RuleFor(x => x.CostElementCode)
            ...
            .Must(TaktRegexHelper.IsValidCostElementCode).WithMessage(TaktValidationMessages.FormatInvalid(localizer, "entity.costelement.costelementcode"));
