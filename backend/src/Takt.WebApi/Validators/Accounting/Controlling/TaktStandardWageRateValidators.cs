...
public class TaktStandardWageRateCreateDtoValidator : AbstractValidator<TaktStandardWageRateCreateDto>
{
    public TaktStandardWageRateCreateDtoValidator(ITaktLocalizer? localizer = null)
    {
        RuleFor(x => x.CompanyCode)
            .NotEmpty().WithMessage(TaktValidationMessages.Required(localizer, "entity.standardwagerate.companycode"))
            .Must(TaktRegexHelper.IsValidCompanyCode).WithMessage(TaktValidationMessages.FormatInvalid(localizer, "entity.standardwagerate.companycode"));
