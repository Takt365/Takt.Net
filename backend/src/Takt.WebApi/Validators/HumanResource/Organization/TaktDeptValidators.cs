...
public class TaktDeptCreateDtoValidator : AbstractValidator<TaktDeptCreateDto>
{
    public TaktDeptCreateDtoValidator(ITaktLocalizer? localizer = null)
    {
        ...
        RuleFor(x => x.CostCenterCode)
            .NotEmpty().WithMessage(TaktValidationMessages.Required(localizer, "entity.dept.costcentercode"))
            .Must(TaktRegexHelper.IsValidCostCenterCode).WithMessage(TaktValidationMessages.FormatInvalid(localizer, "entity.dept.costcentercode"));
