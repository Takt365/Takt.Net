...
public class TaktEmployeeCreateDtoValidator : AbstractValidator<TaktEmployeeCreateDto>
{
    public TaktEmployeeCreateDtoValidator(ITaktLocalizer? localizer = null)
    {
        ...
        RuleFor(x => x.RealName)
            ...
            .Must(TaktRegexHelper.IsValidFullName).WithMessage(TaktValidationMessages.FormatInvalid(localizer, "entity.employee.realname"));
        ...
        RuleFor(x => x.Nationality)
            ...
            .WithMessage(TaktValidationMessages.FormatInvalid(localizer, "entity.employee.nationality"));

        RuleFor(x => x.Political)
            .InclusiveBetween(0, 12)
            .WithMessage(TaktValidationMessages.FormatInvalid(localizer, "entity.employee.political"));

        RuleFor(x => x.Marital)
            .InclusiveBetween(0, 3)
            .WithMessage(TaktValidationMessages.FormatInvalid(localizer, "entity.employee.marital"));
