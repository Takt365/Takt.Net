...
public class TaktEcDetailCreateDtoValidator : AbstractValidator<TaktEcDetailCreateDto>
{
    ...
    {
        RuleFor(x => x.EcnNo)
            .NotEmpty().WithMessage(TaktValidationMessages.Required(localizer, "entity.ecdetail.ecnno"))
            .Length(1, 50).WithMessage(TaktValidationMessages.LengthBetween(localizer, "entity.ecdetail.ecnno", 1, 50));

        RuleFor(x => x.EcnModel)
            .NotEmpty().WithMessage(TaktValidationMessages.Required(localizer, "entity.ecdetail.ecnmodel"))
            .Length(1, 50).WithMessage(TaktValidationMessages.LengthBetween(localizer, "entity.ecdetail.ecnmodel", 1, 50));
        ...
        RuleFor(x => x.IsCheck)
            .InclusiveBetween(0, 0)
            .WithMessage(TaktValidationMessages.FormatInvalid(localizer, "entity.ecdetail.ischeck"));
