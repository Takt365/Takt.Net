...
public class TaktPurchaseOrderCreateDtoValidator : AbstractValidator<TaktPurchaseOrderCreateDto>
{
    public TaktPurchaseOrderCreateDtoValidator(ITaktLocalizer? localizer = null)
    {
        RuleFor(x => x.PlantCode)
            .NotEmpty().WithMessage(TaktValidationMessages.Required(localizer, "entity.purchaseorder.plantcode"))
            .Must(TaktRegexHelper.IsValidPlantCode).WithMessage(TaktValidationMessages.FormatInvalid(localizer, "entity.purchaseorder.plantcode"));
        ...
        RuleFor(x => x.PurchaseGroup)
            .MaximumLength(50).WithMessage(TaktValidationMessages.LengthMax(localizer, "entity.purchaseorder.purchasegroup", 50))
        ...
        RuleFor(x => x.DeliveryStatus)
            ...
            .WithMessage(TaktValidationMessages.FormatInvalid(localizer, "entity.purchaseorder.deliverystatus"));
