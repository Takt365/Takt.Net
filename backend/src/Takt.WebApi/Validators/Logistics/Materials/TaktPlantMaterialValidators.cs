...
public class TaktPlantMaterialCreateDtoValidator : AbstractValidator<TaktPlantMaterialCreateDto>
{
    public TaktPlantMaterialCreateDtoValidator(ITaktLocalizer? localizer = null)
    {
        RuleFor(x => x.PlantCode)
            ...
            .Must(TaktRegexHelper.IsValidPlantCode).WithMessage(TaktValidationMessages.FormatInvalid(localizer, "entity.plantmaterial.plantcode"));
        ...
        RuleFor(x => x.MaterialHierarchy)
            .MaximumLength(200).WithMessage(TaktValidationMessages.LengthMax(localizer, "entity.plantmaterial.materialhierarchy", 200))
