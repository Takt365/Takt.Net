...
public class TaktPurchasePriceCreateDtoValidator : AbstractValidator<TaktPurchasePriceCreateDto>
{
    public TaktPurchasePriceCreateDtoValidator(ITaktLocalizer? localizer = null)
    {
        RuleFor(x => x.PlantCode)
            .NotEmpty().WithMessage(TaktValidationMessages.Required(localizer, "entity.purchaseprice.plantcode"))
            .Must(TaktRegexHelper.IsValidPlantCode).WithMessage(TaktValidationMessages.FormatInvalid(localizer, "entity.purchaseprice.plantcode"));
