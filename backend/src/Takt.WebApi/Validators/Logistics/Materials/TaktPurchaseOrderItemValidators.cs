...
public class TaktPurchaseOrderItemCreateDtoValidator : AbstractValidator<TaktPurchaseOrderItemCreateDto>
{
    public TaktPurchaseOrderItemCreateDtoValidator(ITaktLocalizer? localizer = null)
    {
        RuleFor(x => x.RequestCode)
            .MaximumLength(50).WithMessage(TaktValidationMessages.LengthMax(localizer, "entity.purchaseorderitem.requestcode", 50))
        ...
        RuleFor(x => x.DeliveryStatus)
            ...
            .WithMessage(TaktValidationMessages.FormatInvalid(localizer, "entity.purchaseorderitem.deliverystatus"));
    }
}
