...
public class TaktSalesPriceCreateDtoValidator : AbstractValidator<TaktSalesPriceCreateDto>
{
    public TaktSalesPriceCreateDtoValidator(ITaktLocalizer? localizer = null)
    {
        RuleFor(x => x.PlantCode)
            .NotEmpty().WithMessage(TaktValidationMessages.Required(localizer, "entity.salesprice.plantcode"))
            .Must(TaktRegexHelper.IsValidPlantCode).WithMessage(TaktValidationMessages.FormatInvalid(localizer, "entity.salesprice.plantcode"));
