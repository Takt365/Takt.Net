...
[TaktPermission("humanresource:organization:dept", "部门管理")]
public class TaktDeptsController : TaktControllerBase
{
    ...
    [HttpGet("{id}")]
    [TaktPermission("humanresource:organization:dept:query", "查询部门详情")]
    ...
    /// <returns>部门DTO</returns>
    [HttpPut("status")]
    [TaktPermission("humanresource:organization:dept:status", "更新部门状态")]
