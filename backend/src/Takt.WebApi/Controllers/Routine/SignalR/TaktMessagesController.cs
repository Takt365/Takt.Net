...
[TaktPermission("routine:message", "在线消息管理")]
public class TaktMessagesController : TaktControllerBase
{
    ...
    [HttpGet("list")]
    [TaktPermission("routine:message:list", "查询消息列表")]
    ...
    [HttpGet("{id}")]
    [TaktPermission("routine:message:query", "查询消息详情")]
    ...
    /// <returns>消息DTO</returns>
    [HttpPost]
    [TaktPermission("routine:message:create", "创建消息")]
    ...
    /// <returns>消息DTO</returns>
    [HttpPut("{id}")]
    [TaktPermission("routine:message:update", "更新消息")]
    ...
    [HttpDelete("{id}")]
    [TaktPermission("routine:message:delete", "删除消息")]
    ...
    /// <returns>消息DTO</returns>
    [HttpPut("read")]
    [TaktPermission("routine:message:read", "标记消息已读")]
    ...
    [HttpPost("export")]
    [TaktPermission("routine:message:export", "导出消息")]
