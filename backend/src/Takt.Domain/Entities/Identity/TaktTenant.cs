...
public class TaktTenant : TaktEntityBase
{
    ...
    // 注意：ConfigId 字段已继承自 TaktEntityBase，用于多租户数据隔离和数据库切换
    ...
    /// 租户状态（0=启用，1=禁用）
    /// </summary>
    [SugarColumn(ColumnName = "tenant_status", ColumnDescription = "租户状态", ColumnDataType = "int", IsNullable = false, DefaultValue = "0")]
