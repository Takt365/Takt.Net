...
public class TaktMenu : TaktEntityBase
{
    ...
    /// 菜单编码（唯一索引）
    /// </summary>
    [SugarColumn(ColumnName = "menu_code", ColumnDescription = "菜单编码", ColumnDataType = "nvarchar", Length = 200, IsNullable = false)]
    ...
    /// 是否可见（1=是，0=否）
    /// </summary>
    [SugarColumn(ColumnName = "is_visible", ColumnDescription = "是否可见", ColumnDataType = "int", IsNullable = false, DefaultValue = "1")]
    ...
    /// 菜单状态（1=启用，0=禁用）
    /// </summary>
    [SugarColumn(ColumnName = "menu_status", ColumnDescription = "菜单状态", ColumnDataType = "int", IsNullable = false, DefaultValue = "1")]
