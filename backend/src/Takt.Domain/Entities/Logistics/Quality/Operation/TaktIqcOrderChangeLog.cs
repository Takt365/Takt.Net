...
[SugarIndex("ix_takt_logistics_quality_iqc_order_change_log_iqc_order_id", nameof(IqcOrderId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_quality_iqc_order_change_log_change_time", nameof(ChangeTime), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_quality_iqc_order_change_log_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
public class TaktIqcOrderChangeLog : TaktEntityBase
{
    /// <summary>
