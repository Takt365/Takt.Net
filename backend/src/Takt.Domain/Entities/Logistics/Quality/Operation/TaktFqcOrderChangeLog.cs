...
[SugarIndex("ix_takt_logistics_quality_fqc_order_change_log_fqc_order_id", nameof(FqcOrderId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_quality_fqc_order_change_log_change_time", nameof(ChangeTime), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_quality_fqc_order_change_log_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
public class TaktFqcOrderChangeLog : TaktEntityBase
{
    /// <summary>
