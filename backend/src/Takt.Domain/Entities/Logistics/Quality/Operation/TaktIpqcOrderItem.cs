...
[SugarIndex("ix_takt_logistics_quality_ipqc_order_item_ipqc_order_id", nameof(IpqcOrderId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_quality_ipqc_order_item_order_line", nameof(IpqcOrderId), OrderByType.Asc, nameof(LineNumber), OrderByType.Asc, true)]
[SugarIndex("ix_takt_logistics_quality_ipqc_order_item_material_code", nameof(MaterialCode), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_quality_ipqc_order_item_standard_code", nameof(StandardCode), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_quality_ipqc_order_item_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
public class TaktIpqcOrderItem : TaktEntityBase
{
    /// <summary>
    ...
    /// <summary>
    /// 行号/项号（检验单明细行号，与IpqcOrderId组成联合唯一索引）
    /// </summary>
