...
[SugarIndex("ix_takt_logistics_quality_iqc_order_order_code", nameof(OrderCode), OrderByType.Asc, true)]
[SugarIndex("ix_takt_logistics_quality_iqc_order_source_code", nameof(SourceCode), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_quality_iqc_order_plan_code", nameof(PlanCode), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_quality_iqc_order_supplier_code", nameof(SupplierCode), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_quality_iqc_order_order_status", nameof(OrderStatus), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_quality_iqc_order_config_id", nameof(ConfigId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_quality_iqc_order_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
public class TaktIqcOrder : TaktEntityBase
{
    /// <summary>
    /// 检验单编码（唯一索引）
    /// </summary>
    ...
    /// 来料数量
    /// </summary>
    [SugarColumn(ColumnName = "incoming_quantity", ColumnDescription = "来料数量", ColumnDataType = "decimal", Length = 18, DecimalDigits = 4, IsNullable = false, DefaultValue = "0")]
    public decimal IncomingQuantity { get; set; } = 0;
