...
[SugarIndex("ix_takt_logistics_materials_purchase_price_scale_item_line", nameof(PurchasePriceItemId), OrderByType.Asc, nameof(LineNumber), OrderByType.Asc, true)]
