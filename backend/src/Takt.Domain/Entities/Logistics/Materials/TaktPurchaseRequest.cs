...
[SugarIndex("ix_takt_logistics_materials_purchase_request_request_id", nameof(RequestId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_materials_purchase_request_flow_instance_id", nameof(FlowInstanceId), OrderByType.Asc)]
...
public class TaktPurchaseRequest : TaktEntityBase
{
    ...
    /// 审核人（人员代码）
    /// </summary>
    [SugarColumn(ColumnName = "approver_by", ColumnDescription = "审核人", ColumnDataType = "nvarchar", Length = 50, IsNullable = true)]
    public string? ApproverBy { get; set; }

    /// <summary>
    /// 审核人员工ID（关联 TaktEmployee，序列化为 string 以避免 Javascript 精度问题）
    /// </summary>
    [SugarColumn(ColumnName = "approver_id", ColumnDescription = "审核人员工ID", ColumnDataType = "bigint", IsNullable = true)]
    [JsonConverter(typeof(ValueToStringConverter))]
