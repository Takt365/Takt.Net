...
[SugarIndex("ix_takt_logistics_materials_plant_material_plant_material_unique", nameof(PlantCode), OrderByType.Asc, nameof(MaterialCode), OrderByType.Asc, nameof(MaterialName), OrderByType.Asc, true)]
