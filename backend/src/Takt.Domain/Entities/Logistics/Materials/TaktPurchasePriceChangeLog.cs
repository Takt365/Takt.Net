...
[SugarIndex("ix_takt_logistics_materials_purchase_price_change_log_price_id", nameof(PriceId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_materials_purchase_price_change_log_change_time", nameof(ChangeTime), OrderByType.Desc)]
[SugarIndex("ix_takt_logistics_materials_purchase_price_change_log_change_user_id", nameof(ChangeUserId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_materials_purchase_price_change_log_config_id", nameof(ConfigId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_materials_purchase_price_change_log_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
public class TaktPurchasePriceChangeLog : TaktEntityBase
{
    /// <summary>
    /// 价格ID（关联采购价格表）
    /// </summary>
