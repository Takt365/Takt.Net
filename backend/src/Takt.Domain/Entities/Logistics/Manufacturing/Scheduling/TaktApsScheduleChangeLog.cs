...
/// APS排程变更日志（记录排程的变更历史）
/// </summary>
[SugarTable("takt_logistics_manufacturing_scheduling_aps_schedule_change_log", "APS排程变更日志表")]
[SugarIndex("ix_takt_logistics_manufacturing_scheduling_aps_schedule_change_log_aps_schedule_id", nameof(ApsScheduleId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_scheduling_aps_schedule_change_log_change_time", nameof(ChangeTime), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_scheduling_aps_schedule_change_log_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
public class TaktApsScheduleChangeLog : TaktEntityBase
{
    /// <summary>
