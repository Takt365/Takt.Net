...
/// 生产工单实体
/// </summary>
[SugarTable("takt_logistics_manufacturing_oph_production_order", "生产工单表")]
[SugarIndex("ix_takt_logistics_manufacturing_oph_production_order_prod_order_code", nameof(ProdOrderCode), OrderByType.Asc, true)]
[SugarIndex("ix_takt_logistics_manufacturing_oph_production_order_plant_code", nameof(PlantCode), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_oph_production_order_material_code", nameof(MaterialCode), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_oph_production_order_status", nameof(Status), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_oph_production_order_config_id", nameof(ConfigId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_oph_production_order_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
