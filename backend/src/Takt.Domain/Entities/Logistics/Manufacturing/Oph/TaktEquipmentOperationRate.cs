...
/// </summary>
[SugarTable("takt_logistics_manufacturing_oph_equipment_operation_rate", "机器稼动率表")]
[SugarIndex("ix_takt_logistics_manufacturing_oph_equipment_operation_rate_plant_code", nameof(PlantCode), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_oph_equipment_operation_rate_equipment_code", nameof(EquipmentCode), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_oph_equipment_operation_rate_production_line", nameof(ProductionLine), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_oph_equipment_operation_rate_time_category", nameof(TimeCategory), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_oph_equipment_operation_rate_start_date", nameof(StartDate), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_oph_equipment_operation_rate_end_date", nameof(EndDate), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_oph_equipment_operation_rate_config_id", nameof(ConfigId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_oph_equipment_operation_rate_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
