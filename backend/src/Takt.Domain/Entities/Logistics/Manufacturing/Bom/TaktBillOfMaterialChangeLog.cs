...
[SugarIndex("ix_takt_logistics_manufacturing_bom_change_log_bill_of_material_id", nameof(BillOfMaterialId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_bom_change_log_change_time", nameof(ChangeTime), OrderByType.Desc)]
[SugarIndex("ix_takt_logistics_manufacturing_bom_change_log_config_id", nameof(ConfigId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_bom_change_log_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
public class TaktBillOfMaterialChangeLog : TaktEntityBase
{
    /// <summary>
