...
[SugarIndex("ix_takt_logistics_manufacturing_defect_pcba_repair_unique", nameof(PlantCode), OrderByType.Asc, nameof(ProdCategory), OrderByType.Asc, nameof(ProdDate), OrderByType.Asc, nameof(ProdLine), OrderByType.Asc, nameof(ShiftNo), OrderByType.Asc, nameof(ProdOrderCode), OrderByType.Asc, true)]
[SugarIndex("ix_takt_logistics_manufacturing_defect_pcba_repair_prod_date", nameof(ProdDate), OrderByType.Desc)]
[SugarIndex("ix_takt_logistics_manufacturing_defect_pcba_repair_prod_line", nameof(ProdLine), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_defect_pcba_repair_prod_order_code", nameof(ProdOrderCode), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_defect_pcba_repair_status", nameof(Status), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_defect_pcba_repair_config_id", nameof(ConfigId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_defect_pcba_repair_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
public class TaktPcbaRepair : TaktEntityBase
{
    /// <summary>
    /// 工厂代码
    /// </summary>
