...
[SugarIndex("ix_takt_logistics_manufacturing_defect_assy_defect_status", nameof(Status), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_defect_assy_defect_config_id", nameof(ConfigId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_defect_assy_defect_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
public class TaktAssyDefect : TaktEntityBase
{
    /// <summary>
    /// 工厂代码
    /// </summary>
