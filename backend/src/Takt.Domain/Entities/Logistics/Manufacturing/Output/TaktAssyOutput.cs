...
[SugarIndex("ix_takt_logistics_manufacturing_output_assy_output_status", nameof(Status), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_output_assy_output_config_id", nameof(ConfigId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_output_assy_output_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
