...
[SugarIndex("ix_takt_logistics_manufacturing_output_equipment_operation_rate_eor_unique", nameof(PlantCode), OrderByType.Asc, nameof(EquipmentCode), OrderByType.Asc, nameof(TimeCategory), OrderByType.Asc, nameof(StartDate), OrderByType.Asc, nameof(ShiftNo), OrderByType.Asc, true)]
