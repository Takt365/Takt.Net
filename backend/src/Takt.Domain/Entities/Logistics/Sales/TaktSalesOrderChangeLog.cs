...
[SugarIndex("ix_takt_logistics_sales_order_change_log_order_id", nameof(OrderId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_sales_order_change_log_change_time", nameof(ChangeTime), OrderByType.Desc)]
[SugarIndex("ix_takt_logistics_sales_order_change_log_change_user_id", nameof(ChangeUserId), OrderByType.Asc)]
