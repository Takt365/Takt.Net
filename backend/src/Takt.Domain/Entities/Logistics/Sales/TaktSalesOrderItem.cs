...
[SugarIndex("ix_takt_logistics_sales_order_item_sales_order_id", nameof(SalesOrderId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_sales_order_item_order_line", nameof(SalesOrderId), OrderByType.Asc, nameof(LineNumber), OrderByType.Asc, true)]
[SugarIndex("ix_takt_logistics_sales_order_item_config_id", nameof(ConfigId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_sales_order_item_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
public class TaktSalesOrderItem : TaktEntityBase
{
    /// <summary>
