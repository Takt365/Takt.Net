...
[SugarIndex("ix_takt_logistics_sales_order_item_order_id", nameof(OrderId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_sales_order_item_material_id", nameof(MaterialId), OrderByType.Asc)]
