...
[SugarIndex("ix_takt_logistics_sales_price_item_sales_price_id", nameof(SalesPriceId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_sales_price_item_price_line", nameof(SalesPriceId), OrderByType.Asc, nameof(LineNumber), OrderByType.Asc, true)]
