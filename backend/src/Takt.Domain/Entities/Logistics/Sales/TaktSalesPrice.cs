...
[SugarIndex("ix_takt_logistics_sales_price_effective_from", nameof(EffectiveFrom), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_sales_price_effective_to", nameof(EffectiveTo), OrderByType.Asc)]
