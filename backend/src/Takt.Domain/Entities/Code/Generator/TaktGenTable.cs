...
/// <summary>
/// Takt代码生成表配置实体。表级 GenFunction 为【功能控制】（是否生成查询/新增/更新/删除/模板/导入/导出）；列级 IsQuery/IsCreate/IsExport 等为【字段控制】（该列是否参与查询/新增/导出等），二者含义不同。
/// </summary>
[SugarTable("takt_code_generator_table", "代码生成表配置表")]
[SugarIndex("ix_takt_code_generator_table_table_name", nameof(TableName), OrderByType.Asc, true)]
[SugarIndex("ix_takt_code_generator_table_config_id", nameof(ConfigId), OrderByType.Asc)]
[SugarIndex("ix_takt_code_generator_table_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
public class TaktGenTable : TaktEntityBase
{
    ...
    /// </summary>
    [SugarColumn(ColumnName = "in_database", ColumnDescription = "库表标识", ColumnDataType = "int", IsNullable = false, DefaultValue = "0")]
  ...
  [SugarColumn(ColumnName = "name_prefix", ColumnDescription = "命名空间前缀", ColumnDataType = "nvarchar", Length = 50, IsNullable = true)]
    ...
    /// 是否生成仓储层（0=是，1=否）
    /// </summary>
    [SugarColumn(ColumnName = "is_repository", ColumnDescription = "仓储层", ColumnDataType = "int", IsNullable = false, DefaultValue = "1")]
    ...
    /// <summary>
    /// 生成功能（Query/Create/Update/Delete/Template/Import/Export）。JSON 或逗号分隔；代码生成时根据本字段判断并生成对应功能。
    /// </summary>
   ...
   /// <summary>
    ...
    /// 是否生成菜单（0=是，1=否）
    /// </summary>
    [SugarColumn(ColumnName = "is_gen_menu", ColumnDescription = "生成菜单", ColumnDataType = "int", IsNullable = false, DefaultValue = "0")]
  ...
  [SugarColumn(ColumnName = "parent_menu_id", ColumnDescription = "上级菜单ID", ColumnDataType = "bigint", IsNullable = false, DefaultValue = "0")]
    ...
    /// 是否生成翻译（0=是，1=否）
    /// </summary>
    [SugarColumn(ColumnName = "is_gen_translation", ColumnDescription = "生成翻译", ColumnDataType = "int", IsNullable = false, DefaultValue = "0")]
    ...
    /// 是否生成代码（0=是，1=否）
    /// </summary>
    [SugarColumn(ColumnName = "is_gen_code", ColumnDescription = "是否生成", ColumnDataType = "int", IsNullable = false, DefaultValue = "1")]
    ...
    /// 是否使用tabs（0=是，1=否）
    /// </summary>
    [SugarColumn(ColumnName = "is_use_tabs", ColumnDescription = "使用tabs", ColumnDataType = "int", IsNullable = false, DefaultValue = "1")]
