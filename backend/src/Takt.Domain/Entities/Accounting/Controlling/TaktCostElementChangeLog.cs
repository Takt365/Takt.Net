...
[SugarIndex("ix_takt_accounting_controlling_cost_element_change_log_cost_element_id", nameof(CostElementId), OrderByType.Asc)]
[SugarIndex("ix_takt_accounting_controlling_cost_element_change_log_change_time", nameof(ChangeTime), OrderByType.Desc)]
[SugarIndex("ix_takt_accounting_controlling_cost_element_change_log_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
public class TaktCostElementChangeLog : TaktEntityBase
{
    /// <summary>
    /// 成本要素ID（主子表关系，序列化为string以避免Javascript精度问题）
    /// </summary>
