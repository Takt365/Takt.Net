...
[SugarIndex("ix_takt_accounting_controlling_profit_center_company_code", nameof(CompanyCode), OrderByType.Asc)]
[SugarIndex("ix_takt_accounting_controlling_profit_center_plant_id", nameof(PlantId), OrderByType.Asc)]
[SugarIndex("ix_takt_accounting_controlling_profit_center_company_code_profit_center_code", nameof(CompanyCode), OrderByType.Asc, nameof(ProfitCenterCode), OrderByType.Asc, true)]
