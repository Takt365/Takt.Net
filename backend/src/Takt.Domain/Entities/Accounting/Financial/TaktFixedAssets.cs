...
// 文件名称：TaktFixedAssets.cs
// 功能描述：Takt固定资产实体，定义固定资产领域模型
//
...
/// Takt固定资产实体
/// </summary>
[SugarTable("takt_accounting_financial_fixed_assets", "固定资产表")]
[SugarIndex("ix_takt_accounting_financial_fixed_assets_company_code", nameof(CompanyCode), OrderByType.Asc)]
[SugarIndex("ix_takt_accounting_financial_fixed_assets_plant_id", nameof(PlantId), OrderByType.Asc)]
[SugarIndex("ix_takt_accounting_financial_fixed_assets_asset_code", nameof(AssetCode), OrderByType.Asc, true)]
[SugarIndex("ix_takt_accounting_financial_fixed_assets_asset_category_id", nameof(AssetCategoryId), OrderByType.Asc)]
[SugarIndex("ix_takt_accounting_financial_fixed_assets_cost_center_id", nameof(CostCenterId), OrderByType.Asc)]
[SugarIndex("ix_takt_accounting_financial_fixed_assets_dept_id", nameof(DeptId), OrderByType.Asc)]
[SugarIndex("ix_takt_accounting_financial_fixed_assets_config_id", nameof(ConfigId), OrderByType.Asc)]
[SugarIndex("ix_takt_accounting_financial_fixed_assets_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
[SugarIndex("ix_takt_accounting_financial_fixed_assets_asset_status", nameof(AssetStatus), OrderByType.Asc)]
public class TaktFixedAssets : TaktEntityBase
{
    /// <summary>
    /// 公司代码（关联公司主数据）
    /// </summary>
