...
[SugarIndex("ix_takt_accounting_financial_countersign_countersign_code", nameof(CountersignCode), OrderByType.Asc, true)]
[SugarIndex("ix_takt_accounting_financial_countersign_company_code", nameof(CompanyCode), OrderByType.Asc)]
[SugarIndex("ix_takt_accounting_financial_countersign_application_date", nameof(ApplicationDate), OrderByType.Desc)]
[SugarIndex("ix_takt_accounting_financial_countersign_config_id", nameof(ConfigId), OrderByType.Asc)]
[SugarIndex("ix_takt_accounting_financial_countersign_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
[SugarIndex("ix_takt_accounting_financial_countersign_countersign_status", nameof(CountersignStatus), OrderByType.Asc)]
[SugarIndex("ix_takt_accounting_financial_countersign_flow_instance_id", nameof(FlowInstanceId), OrderByType.Asc)]
public class TaktCountersign : TaktEntityBase
{
    /// <summary>
    /// 公司代码
    /// </summary>
