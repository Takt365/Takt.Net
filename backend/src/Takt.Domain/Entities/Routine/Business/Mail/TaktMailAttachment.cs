...
// 文件名称：TaktMailAttachment.cs
// 创建时间：2025-01-20
// 创建人：Takt365(Cursor AI)
// 功能描述：Takt邮件附件实体，定义邮件附件领域模型
// 
...
/// Takt邮件附件实体
/// </summary>
[SugarTable("takt_routine_mail_attachment", "邮件附件表")]
[SugarIndex("ix_takt_routine_mail_attachment_mail_id", nameof(MailId), OrderByType.Asc)]
[SugarIndex("ix_takt_routine_mail_attachment_file_id", nameof(FileId), OrderByType.Asc)]
[SugarIndex("ix_takt_routine_mail_attachment_config_id", nameof(ConfigId), OrderByType.Asc)]
[SugarIndex("ix_takt_routine_mail_attachment_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
public class TaktMailAttachment : TaktEntityBase
{
    /// <summary>
    ...
    /// 邮件（主表）
    /// </summary>
    [Navigate(NavigateType.ManyToOne, nameof(MailId))]
    public TaktMail? Mail { get; set; }
}
