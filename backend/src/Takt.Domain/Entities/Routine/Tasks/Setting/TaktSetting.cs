...
// 命名空间：Takt.Domain.Entities.Routine.Tasks.Setting
// 文件名称：TaktSetting.cs
// 创建时间：2025-01-20
...
public class TaktSetting : TaktEntityBase
{
    /// <summary>
    /// 设置键（唯一索引）
    /// </summary>
    ...
    /// 设置状态（1=启用，0=禁用）
    /// </summary>
    [SugarColumn(ColumnName = "setting_status", ColumnDescription = "设置状态", ColumnDataType = "int", IsNullable = false, DefaultValue = "1")]
