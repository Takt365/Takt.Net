...
// 命名空间：Takt.Domain.Entities.Routine.Tasks.Vocabulary
...
namespace Takt.Domain.Entities.Routine.Tasks.Vocabulary;

/// <summary>
/// 敏感词实体
/// </summary>
[SugarTable("takt_routine_vocabulary", "敏感词表")]
[SugarIndex("ix_takt_routine_vocabulary_word_text", nameof(WordText), OrderByType.Asc, true)]
[SugarIndex("ix_takt_routine_vocabulary_word_category", nameof(WordCategory), OrderByType.Asc)]
[SugarIndex("ix_takt_routine_vocabulary_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
public class TaktVocabulary : TaktEntityBase
{
    /// <summary>
    /// 敏感词文本
    /// </summary>
