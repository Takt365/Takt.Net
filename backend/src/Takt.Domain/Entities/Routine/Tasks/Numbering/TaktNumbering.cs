...
// 命名空间：Takt.Domain.Entities.Routine.Tasks.Numbering
...
namespace Takt.Domain.Entities.Routine.Tasks.Numbering;

/// <summary>
/// Takt编码规则实体
/// </summary>
[SugarTable("takt_routine_numbering", "编码规则表")]
[SugarIndex("ix_takt_routine_numbering_rule_code", nameof(RuleCode), OrderByType.Asc, true)]
[SugarIndex("ix_takt_routine_numbering_config_id", nameof(ConfigId), OrderByType.Asc)]
[SugarIndex("ix_takt_routine_numbering_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
[SugarIndex("ix_takt_routine_numbering_rule_status", nameof(RuleStatus), OrderByType.Asc)]
[SugarIndex("ix_takt_routine_numbering_company_code", nameof(CompanyCode), OrderByType.Asc)]
[SugarIndex("ix_takt_routine_numbering_dept_code", nameof(DeptCode), OrderByType.Asc)]
public class TaktNumbering : TaktEntityBase
{
    /// <summary>
    ...
    /// <summary>
    /// 当前序号（下次生成时使用的序号，生成后自动递增 Step）
    /// </summary>
    [SugarColumn(ColumnName = "current_number", ColumnDescription = "当前序号", ColumnDataType = "bigint", IsNullable = false, DefaultValue = "1")]
    ...
    /// 规则状态（1=启用，0=禁用）
    /// </summary>
    [SugarColumn(ColumnName = "rule_status", ColumnDescription = "规则状态", ColumnDataType = "int", IsNullable = false, DefaultValue = "1")]
    public int RuleStatus { get; set; } = 1;
}
