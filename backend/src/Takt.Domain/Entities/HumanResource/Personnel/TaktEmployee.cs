...
public class TaktEmployee : TaktEntityBase
{
    ...
    /// <summary>
    /// 民族（与字典 ht_nationality 一致：0=汉族，1=少数民族...共56个民族）
    /// </summary>
    [SugarColumn(ColumnName = "nationality", ColumnDescription = "民族", ColumnDataType = "int", IsNullable = false, DefaultValue = "0")]
    public int Nationality { get; set; } = 0;

    /// <summary>
    /// 政治面貌（与字典 hr_political 一致：0=群众，1=共青团员，2=中共党员，3=中共预备党员，4=民革党员，5=民盟盟员，6=民建会员，7=民进会员，8=农工党党员，9=致公党党员，10=九三学社社员，11=台盟盟员，12=无党派民主人士）
    /// </summary>
    [SugarColumn(ColumnName = "political", ColumnDescription = "政治面貌", ColumnDataType = "int", IsNullable = false, DefaultValue = "0")]
    public int Political { get; set; } = 0;

    /// <summary>
    /// 婚姻状况（0=未婚，1=已婚，2=离异，3=丧偶）
    /// </summary>
    [SugarColumn(ColumnName = "marital", ColumnDescription = "婚姻状况", ColumnDataType = "int", IsNullable = false, DefaultValue = "0")]
    public int Marital { get; set; } = 0;
